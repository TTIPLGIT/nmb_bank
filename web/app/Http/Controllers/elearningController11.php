...
class kojiu extends BaseController
{
    ...
    function courseImport()
    {
        ...
        foreach ($courses as $course) {
            ...
            $isOldCourse = DB::select("select * from elearning_courses where id=$courseId");
        ...
        $availableCourses = DB::select("select id from elearning_courses where drop_course=0");
    ...
    function classImport()
    {
        ...
        $availableClasses = DB::select("select id from elearning_classes where drop_class=0");
    ...
    public function courseOverview(Request $request, $id)
    {
        ...
        $id = Crypt::decrypt($id);
        $courseDetails = DB::select("SELECT * FROM elearning_courses WHERE drop_course=0 AND id=$id");
    ...
    public function takeCourse(Request $request, $id)
    {
        ...
        // dd($courseContents);
        // $this->WriteFileLog($courseContents);
        return view('elearning.class', compact('courseDetails', 'courseContents', 'classOrder', 'isForum', 'questionAdded', 'askedQuestions', 'noQuestionsYet'));
    }
    ...
    public function addQuestion(Request $request, $id)
    {
        ...
        return redirect(route('/elearningCourse/class/"eyJpdiI6ImdPQ2NsaWY2RnZnbHB0bEg2L3pNM3c9PSIsInZhbHVlIjoiclVvbjYyQ3pxU2o2bU1hamRCUWdKdz09IiwibWFjIjoiNThiNDNkOGFmZjQwYWY2ZGVlNTMwZjIxYTM3NmRhYTFmZTA4YWY1NjYzMGE2OGMyODkyNmI3YWQzNTdiYjM4YiIsInRhZyI6IiJ9"'));
    }

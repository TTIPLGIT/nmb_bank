...
class elearningControllerold extends BaseController
{
    ...
    public function allCourses(Request $request)
    {
        ...
        return view('elearning.allCourses', compact('availableCourses', 'availableTags', 'search', 'sort', 'tagFilter', 'progressFilter','modules', 'screens'));
    }

...
<div class="main-content main_contentspace">
    <div class="row">
        {{ Breadcrumbs::render('ethictest.index') }}
        <div class=" col-md-12">
            <section class="section5">
                <div class="section-body mt-2">
                    <a type="button" style="font-size:15px;margin: 0 0px 5px 15px; border-color:#a9ca !important;" class="btn btn-success btn-lg" title="Test Create" id="gcb" href="" data-toggle="modal" data-target="#addModal1">Ethics Test
                                            ...
                                            <table class="table table-bordered" id="align1">
                                                ...
                                                <tbody style="background-color: #cfe0e8;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ellipsis">{{$data['ethnictest_name']}}</td>
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="create_form" enctype="multipart/form-data" class="reset">
                ...
                <div class="modal-header mh">
                    <h4 class="modal-title">Create Ethics Test</h4>
                ...
                <div class="modal-body" style="background-color: #ffffff !important;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Ethics Test Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="ethnictest_name" name="ethnictest_name" autocomplete="off" placeholder="Please Enter the Ethic Test Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label required">Quiz Name:<span class="error-star" style="color:red;">*</span></label></br>
...
<div class="modal fade modalreset" id="addModal2">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('ethictest.update',1)}}" method="POST" id="ethnicupdate" enctype="multipart/form-data" class="reset">
                @method('put')
                @csrf
                <input type="hidden" name="eid" class="eid" id="eid">

                <div class="modal-header mh">
                    <h4 class="modal-title">Edit Ethics Test</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body" style="background-color: #ffffff !important;">
                    <input type="hidden" class="form-control" id="user_id" name="user_id" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Ethics Test Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="ethnictest_nameedit" name="ethnictest_name" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="" id="ethnicshow" enctype="multipart/form-data" class="reset">
                ...
                <div class="modal-header mh">
                    <h4 class="modal-title">Show Ethics Test</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body" style="background-color: #ffffff !important;">
                    <input type="hidden" class="form-control" id="user_id" name="user_id" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Ethics Test Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="ethnictest_nameshow" name="ethnictest_name" autocomplete="off" style="background-color: #e9ecef !important;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script>
    ...
    function gencre(id) {
        ...
        if (id == "1") {
            ...
            var t_name = $("#ethnictest_name").val();
            if (t_name == '') {
                swal.fire("Please Enter the Ethics Test Name", "", "error");
                return false;
            }
            ...
            var t_nameedit = $("#ethnictest_nameedit").val();
            if (t_nameedit == '') {
                swal.fire("Please Enter the Ethics Test Name", "", "error");
                return false;
            }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (type == "edit") {
                    ...
                    $('#ethnictest_nameedit').val(data.rows[0]['ethnictest_name']);
                    ...
                    $('#ethnictest_nameshow').val(data.rows[0]['ethnictest_name']);
                    ...
                    $('#ethnictest_nameshow').prop('disabled', true);
...
<script>
    function delete1(id) {
        Swal.fire({
            title: "Are you  you want to delete the Ethics Test?",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        if (result.value) {
                            Swal.fire("Success!", "Ethics Test Deleted Successfully!", "success").then((result) => {

                                location.replace(`/ethictest`);

...
<div class="main-content main_contentspace">
    <div class="row">
        {{ Breadcrumbs::render('ethictest.list') }}
        <div class=" col-md-12">
                                            ...
                                            <table class="table table-bordered" id="align1">
                                                ...
                                                <tbody style="background-color: #cfe0e8;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>-</td>
                                                        <td>
                                                            <a class="btn btn-primary" style="border-radius: 50px !important;background-color: darkblue;" href="{{ route('ethictest.quiz') }}">Take Test</a>

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="phone_number"
                                                ...
                                                value="{{ $one_row[0]['phone_number'] }}" autocomplete="off">
                                            @error('phone_number')
                                            <div class="error">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="phone_error" class="error hidden">Please enter a valid phone number
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="small-12 medium-2 large-2 columns">
                                                    <div class="circle11">
                                                        <img class="profile-pic" value=""
                                                            src="{{ $one_row[0]['profile_image'] }}">
                                                    ...
                                                    <div class="p-image">
                                                        ...
                                                        <input class="file-upload" type="file" id="signature_attachment"
                                                            name="signature_attachment"
                                    ...
                                    <div class="row text-center">
                                        <div class="col-md-12">
                                            ...
                                            <button class="btn btn-success" id="update_button" type="submit"><i
                                                    class="fa fa-check"></i>
                                                Update </button>&nbsp;

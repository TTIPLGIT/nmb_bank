...
<div class="main-content main_contentspace">
    <div class="row">
        {{ Breadcrumbs::render('elearning.notice_list') }}
        <div class=" col-md-12">

            <section class="section5">
                <div class="section-body mt-2">
                    <a type="button" style="font-size:15px;margin: 0 0px 5px 15px;" class="btn btn-success btn-lg question" title="Create" href="" data-toggle="modal" data-target="#addModal">Add Notice Board <span><i class="fa fa-plus" aria-hidden="true"></i></span></a>
                    @if (session('success'))
                                            ...
                                            <table class="table table-bordered" id="align1">
                                                ...
                                                <tbody style="background-color: #cfe0e8;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ellipsis">{{$data['notice_author']}}</td>
...
<script>
    function notice_delete(notice_id) {
        //alert(id);
        Swal.fire({
            title: "Are you sure, you want to delete the Notice Board?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('elearning.notice_delete') }}",
                    type: 'POST',
                    data: {
                        notice_id: notice_id,
                    ...
                    success: function(data) {
                        ...
                        if (result.value) {
                            Swal.fire("Success!", "Notice Board Deleted Successfully!", "success").then((result) => {

                                location.replace(`/adminnoticeboard`);
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="notice_form" action="{{ route('elearning.notice_store')}}" name="add_notice" enctype="multipart/form-data" class="reset">
                ...
                <div class="card longquestion" id="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Notice Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_name" name="notice_name" autocomplete="off" placeholder="Please Enter the Notice Name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control default" id="notice_banner" name="notice_banner" accept="image/*" autocomplete="off">
                                <span style="color:red !important"><strong>Following files could be uploaded as jpeg,png,jpg,gif</strong></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control notice_description" id="notice_description" name="notice_description" rows="8" columns="10" autocomplete="off" required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control default startdate" id="notice_date" name="notice_date" autocomplete="off" placeholder="Please Select the Notice Date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Notice Author:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_author" name="notice_author" autocomplete="off" placeholder="Please Enter the Notice Author">
                            </div>
                        </div>
...
<div class="modal fade" id="addModal4">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{route('elearning.notice_update',1)}}" id="edit_form" enctype="multipart/form-data">
                ...
                <div class=" container edit  longquestion">
                    <h4 class="modal-title long">Edit Notice</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Notice Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_nameedit" name="notice_nameedit" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control default" id="notice_banneredit" name="notice_banneredit" style="display:none;" accept="image/*" autocomplete="off">

                                <img class="img-fluid" alt="Banner Image" title="">
                            </div>
                            <span style="color:red !important"><strong>Following files could be uploaded as jpeg,png,jpg,gif</strong></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="">Description<span class="error-star" style="color:red;">*</span></label>
                                <textarea class="form-control notice_description" id="notice_descriptionedit" name="notice_descriptionedit" rows="8" columns="10" required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Notice Date:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default startdate" id="notice_dateedit" name="notice_dateedit" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Author:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_authoredit" name="notice_authoredit" autocomplete="off">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <button class="btn btn-success btn-space" type="button" onclick="gencre('edit')" id="savebutton">Update</button>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="" action="" id="show_form" enctype="multipart/form-data">
                ...
                <div class=" container edit  longquestion">
                    <h4 class="modal-title long">Show Notice Board</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Notice Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_nameshow" name="notice_nameshow" autocomplete="off" style="background-color: #e9ecef !important;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <iframe id="noticebanner_show" class="img-fluidshow" alt="Banner Image" title="" width="400" height="200" style="background-color: #e9ecef !important;width:100% !important;"></iframe>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="">Description<span class="error-star" style="color:red;">*</span></label>
                                <textarea class="form-control" id="notice_descriptionshow" name="notice_descriptionshow" rows="8" columns="10" required style="background-color: #e9ecef !important;"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Notice Date:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_dateshow" name="notice_dateshow" autocomplete="off" style="background-color: #e9ecef !important;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Author:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" id="notice_authorshow" name="notice_authorshow" autocomplete="off" style="background-color: #e9ecef !important;">
                            </div>
                        </div>
...
<script>
    ...
    function changeimage(e) {
        if (e.target.id == "change_banner") {
            document.querySelector('#notice_banneredit').style.display = "block";
            ...
            document.querySelector('#notice_banneredit').style.display = "none";
...
<script>
    function gencre(id) {
        ...
        if (id == "1") {
            ...
            var notice_banner = $("#notice_banner").val();
            if (notice_banner == '') {
                swal.fire("Please Upload The Noticeboard Image", "", "error");
                return false;
            }
            var editor = tinymce.get(document.querySelector('#notice_description').id);
            ...
            //     return false;
            // }
            var editor = tinymce.get(document.querySelector('#notice_descriptionedit').id);
            // Check if the editor instance and its content exist
            if (editor && editor.getContent().trim() === '') {
                swal.fire("Please Enter the Notice Description", "", "error");
                return false;
...
<script>
    $(document).ready(function() {
        ...
        tinymce.init({
            selector: 'textarea.notice_description',
            height: 180,
            menubar: 'table',
            branding: false,
        ...
        var show = tinymce.init({
            selector: 'textarea#notice_descriptionshow',
            height: 180,
            menubar: 'table',
            branding: false,
            plugins: 'table textcolor',
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (type == "edit") {
                    ...
                    editor[1].setContent('');
                    editor[1].insertContent(data.rows[0]['notice_description']);
                    $('#user_categoryedit').val(data.rows[0]['user_category']);
                    $('#notice_nameedit').val(data.rows[0]['notice_name']);
                    $('#notice_banneredit').text(data.rows[0]['notice_banner']);
                    $('#notice_descriptionedit').text(data.rows[0]['notice_description']);

                    $('#notice_dateedit').val(data.rows[0]['notice_date']);
                    $('.img-fluid').attr('src', data.rows[0]['full_notice_path']);
                    $('.img-fluid').attr('title', data.rows[0]['notice_banner']);
                    $('#notice_authoredit').val(data.rows[0]['notice_author']);
                    $('#eid').val(data.rows[0]['notice_id']);

                } else {

                    var editor = tinymce.get();
                    editor[2].setContent('');
                    editor[2].insertContent(data.rows[0]['notice_description']);
                    $('#user_categoryshow').val(data.rows[0]['user_category']);
                    $('#notice_nameshow').val(data.rows[0]['notice_name']);
                    $('#notice_descriptionshow').val(data.rows[0]['notice_description']);

                    $('#notice_dateshow').val(data.rows[0]['notice_date']);
                    $('.img-fluidshow').attr('src', data.rows[0]['full_notice_path']);
                    $('.img-fluidshow').attr('title', data.rows[0]['notice_banner']);
                    $('#notice_authorshow').val(data.rows[0]['notice_author']);
                    $('#eid_show').val(data.rows[0]['notice_id']);

                    $('#user_categoryshow').prop('disabled', true);
                    $('#notice_nameshow').prop('disabled', true);
                    $('#notice_descriptionshow').prop('disabled', true);
                    $('#notice_dateshow').prop('disabled', true);
                    $('#notice_authorshow').prop('disabled', true);

                        ...
                        <div class="card-body">
                            ...
                            <div class="certificate-wrapper">
                                <div class="certificate">
                                    ...
                                    <img src="{{asset('images/Certificate_template/NMB_level1/top_right_border.PNG')}}"
                                        class="top-right-image">
                                    <img src="{{ asset('images/Certificate_template/NMB_level1/new_left_bottom.png') }}"
                                        alt="Deco cor" class="bottom-left-image">

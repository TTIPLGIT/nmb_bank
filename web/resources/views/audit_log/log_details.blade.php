...
<div class="main-content">
    ...
    <section class="section">
        {{ Breadcrumbs::render('auditlogs') }}

        <div class="col-lg-12 text-center">
            <h4 style="color:darkblue;">Audit Logs</h4>
        </div>
        <form class="form-horizontal" action="{{ route('log_details') }}" method="POST">
            @csrf
                        ...
                        <div class="card-body" id="card_header">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <form action="{{ route('auditlog.export') }}" method="POST">
                                        @csrf

...
<div class="main-content">
    ...
    <section class="section">
        ...
        <div class="col-lg-12 text-center">
            <h4 style="color:darkblue;">Login/Logout Details</h4>
        </div>
        <form class="form-horizontal" action="{{ route('auditlog.login') }}" method="POST">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" id="from_date" name="from_date"
                            placeholder="Enter receipt #" value="{{ $from_date}}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" id="to_date" name="to_date"
                            placeholder="Enter received for" value="{{ $to_date}}">
                    </div>
                </div>
            ...
            <div class="row text-center">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-search"></i>&nbsp;&nbsp;
                        ...
                        <div class="card-body" id="card_header">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <form action="{{ route('login.audit.export') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ $user_id }}">
                                        <input type="hidden" name="from_date" value="{{ $from_date }}">
                                        <input type="hidden" name="to_date" value="{{ $to_date }}">

                                        <button class="btn btn-primary"><i class="fa fa-file-excel-o"
                                                aria-hidden="true"></i>&nbsp;&nbsp;
                                            Download Excel
                                        </button>
                                    </form>
                                    ...
                                    <table class="table table-bordered" id="align">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>Audit#00{{ $key }}</td>
                                                <td> {{ \Carbon\Carbon::parse($row['login_time'])->format('d-m-Y h:i A') }}
                                                </td>
                                                <td> {{ \Carbon\Carbon::parse($row['logout_time'])->format('d-m-Y h:i A') }}
                                                </td>
                                                <td>{{ $row['status1'] }}</td>
                                                <td>{{ $row['name'] }}</td>
                                                <td>{{ $row['email'] }}</td>

    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="main-content" style="height:100%; padding: 15px">
                ...
                <div id="assetshow">
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-graduation-cap" aria-hidden="true"></i><b>Education Details</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                        ...
                                        <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="trc">
                                                    ...
                                                    <th style="width: 23%">{{date('d-m-Y', strtotime($data['fde']))}}</th>
                ...
                @foreach($rows['approved_certification'] as $key=>$data)
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="approv"><b>Approved Certificate</b></label>
                        <a type="button" class="btn btn-success " title="Download Documents" href="{{$data['file_path']}}/{{$data['file_name']}}" download><i class="fa fa-download" style="color:white!important"></i></a>
                ...
                @if($rows['approved_certification'][0]['comments'] !=null)
                <div class="col-md-12 form-group">
                    <div id="" style="margin: 20px;">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="form-label" for="textAreaExample">Previous Comment</h3>
                            </div>
                            <div class="card-body">
                                <div class="row d-flex align-items-center">
                                    <span> {!!$rows['approved_certification'][0]['comments']!!}</span>
                                </div>
                ...
                <form action="{{route('approvescreen_update')}}" method="POST" id="nrv_approve">
                    @csrf
                    <input type="hidden" name="previous_comment" id="previous_comment" value="{{$rows['approved_certification'][0]['comments']}}">
                    <div class="form-group">
                        <div id="previousnotes" style="margin: 20px;">
                            @if($rows['approved_certification'][0]['status'] =='0')
                            <div id="editor"></div>
                    ...
                    <div style="display:flex; justify-content:center; align-items:baseline; width:100%">
                        ...
                        @if($rows['approved_certification'][0]['status']==0 )
                        <a type="button" class="btn btn-labeled btn-info" onclick="status(1)" title="Update" style="background: green !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-up"></i></span>Approve</a>

                        <a type="button" id="update" onclick="status(2)" class="btn btn-labeled btn-info" title="next" style="background: blue !important; border-color:blue !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
...
<script type="text/javascript">
    ...
    function reject(e) {
        ...
        Swal.fire({
            ...
            text: "Are sure you want to approve the NRU Application.",
            icon: "warning",
    ...
    function reject2(e) {
        ...
        Swal.fire({
            title: "Are you want to Reject?",
            text: "Please click yes to reject he NUR Application .",
            icon: "warning",
            customClass: 'swalalerttext',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
    ...
    function status(id) {
        ...
        swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Cancel button clicked or outside modal clicked
...
<script>
    function approve_comment() {
        var app = $("#previous_comment").val();
        if (app == '') {
            swal.fire("Please Enter Your Valid Comments", "", "error");
            return false;
        } else {
            document.getElementById('nrv_approve').submit();
        }

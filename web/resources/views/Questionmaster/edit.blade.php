...
<div class="modal fade" id="editModal{{$row['id']}}">
    ...
    <form  action="{{route('qmaster.update', $row['id'])}}" method="POST" id="create_form" enctype="multipart/form-data">
	{{ csrf_field() }}
        @method('PUT')
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control default"  required id="question" name="question"value="{{ $row['question'] }}">
							</div>
						</div>

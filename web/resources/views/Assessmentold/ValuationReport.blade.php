...
<div class="main-content">
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
            ...
            {{ Breadcrumbs::render('ValuationReport') }}
                <form method="POST" id="generalupdate_form" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 15%">NIN Number</th>
                    ...
                    <div id="assetshow">
                        ...
                        <div class="tile" id="tile-1" style="margin-top:10px !important;">
                            ...
                            <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                                ...
                                <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                    <a class="nav-link  " id="home-tab" name="tab" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/evaluate1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="36"><b> Evaluation Report</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                        <div class="check"></div>
                                    </a>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 7%">S.No</th>
                                                            <th style="width: 15%">Size of the plot</th>
                                                            <th style="width: 20%">Total Extend of the plot</th>
                                                            <th style="width: 15%">Prevailing market rate</th>
                                                            <th style="width: 20%">Guideline Rate obtained from Register office</th>
                                                            <th style="width: 20%">Assessed/adopted rate of valuation</th>
                                                            <th style="width: 20%"> Estimate Value of the Land</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr class="trc">
                                                            <td>1</td>
                                                            <td style="word-break: break-all;">2000 Sq.mt</td>
                                                            <td style="word-break: break-all;">2200 Sq.mt</td>
                                                            <td style="word-break: break-all;">11,20,000 </td>
                                                            <td style="word-break: break-all;">11,40,000 </td>
                                                            <td style="word-break: break-all;">11,30,000</td>
                                                            <td style="word-break: break-all;">11,30,000</td>
                        ...
                        <div class="tile" id="tile-1" style="margin-top:10px !important;">
                            ...
                            <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                                ...
                                <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                    <a class="nav-link  " id="home-tab" name="tab" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/inspect1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="36"><b> Inspection Report</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                        <div class="check"></div>
                                    </a>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 7%">S.No</th>
                                                            <th style="width: 15%">Boundaries of the property</th>
                                                            <th style="width: 15%">Extent of the site</th>
                                                            <th style="width: 15%">Develpoment of Surrounding Area</th>
                                                            <th style="width: 15%">Feasibility to the Civic amenities</th>
                                                            <th style="width: 15%">Classification of locality</th>
                                                            <th style="width: 10%">Water potentiality</th>
                                                            <th style="width: 10%"> Underground sewerage system</th>
                                                            <th style="width: 15%"> Power supply available in the site</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr class="trc">
                                                            ...
                                                            <td style="word-break: break-all;">2000 Sq.mt</td>
                                                            <td style="word-break: break-all;">2200 Sq.mt</td>
                                                            <td style="word-break: break-all;">Partially Developed </td>
                                                            <td style="word-break: break-all;">Schools,hospitals in 1 km </td>
                                                            <td style="word-break: break-all;">Residential</td>
                                                            <td style="word-break: break-all;">Yes</td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 7%">S.No</th>
                                                            <th style="width: 15%">Advantage of the site</th>
                                                            <th style="width: 15%">Disadvantage of the site</th>
                                                            <th style="width: 15%">General remarks</th>
                                                            <th style="width: 15%">External Inspection Report</th>
                                                            <th style="width: 15%">Notes</th>
                                                            <th style="width: 10%">Internal Inspection Report</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="trc">
                                                            <td>1</td>
                                                            <td style="word-break: break-all;">Better Civic ammenties</td>
                                                            <td style="word-break: break-all;">Can't be used in farming</td>
                                                            <td style="word-break: break-all;">Good to build a house </td>
                                                            <td> <img style="width: 26px;" src="https://fia-uganda-edrms.com/images/pdf.png">
                                                        <a href="/userdocuments/registration/education/dip/cc/1/0/form-Details-(6).pdf" download="">Form1-3-05-1.pdf</a>
                                                    </td>
                                                            <td style="word-break: break-all;">Schools,hospitals in 1 km</td>
                                                        ...
                                                        <a href="/userdocuments/registration/education/dip/cc/1/0/form-Details-(6).pdf" download="">Form1-3-05-1.pdf</a>
                                                            ...
                                                            <td style="word-break: break-all;">Buildings near by</td>
                    ...
                    <div style="display:flex; justify-content:center; width:100%">
                        ...
                        <a type="button" class="btn btn-labeled btn-info" href="{{ url()->previous() }}" title="next" style="background: red !important; border-color:red !important; color:white !important; margin-top:15px !important;">
                            ...
                            <a type="button" class="btn btn-labeled btn-success" href="{{url('Registration')}}" title="next" style=" color:white !important; margin-top:15px !important; margin-left:15px !important;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-file"></i></span>Generate Report</a>
                    </div>

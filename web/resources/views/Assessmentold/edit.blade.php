...
<div class="main-content">
   ...
   {{ Breadcrumbs::render('Assessment.edit',1) }} 
                <form action="{{ route('Registration.update',1) }}" method="POST" id="generalupdate_form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="Rahul">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Father Name:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="Ragu">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Date of Birth:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="Date" class="form-control default" required id="asset_name" name="asset_name" value="1976-12-11">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="No 40 MacKinnon Road,">
                                            </div>
                                        </div>
                                        <!-- </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control default" required id="Parish" name="Parish">
                                                    <option value="Nabubya">Nabubya</option>
                                                    <option value="Nabubya">Nabubya</option>
                                                    <option value="Labwor County">Labwor County</option>
                                                    <option value="Mazuri County">Mazuri County</option>
                                                </select>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control default" required id="village" name="village">
                                                    <option value="Bugoba">Bugoba</option>
                                                    <option value="Bugoba">Bugoba</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control default" maxlength="12" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required id="nin" name="nin" value="87977576789">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <!-- <input class="form-control " type="file" id="ninf" name="ninf" readonly  value="" required autocomplete="off"> -->
                                                        <button type="button" class="btn btn-info " id="f" title="change Documents" value="1" onclick="changefile1(this,'ninf')"><input class="certf" type="hidden" id="i1" name="f1" value="1"><input type="hidden" id="yn1" name="yn" value="1"><i class="fa fa-exchange" id="fi1" style="color:white!important"> Change File</i></button>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group "> <label style="display:flex"> <a type="button" class="btn btn-success " title="Download Documents" href="/userdocuments/registration/education/dip/cc/1/0/form-Details-(6).pdf" download="" style="margin-inline:5px"><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onclick="getproposaldocument('/userdocuments/registration/education/dip/cc/1/0/form-Details-(6).pdf')" style="margin-inline:5px"><input type="hidden" class="cert" id="ocfn1" name="cert[0][ocfn]" value="notes-in-13-06-2022.txt"><input type="hidden" class="cert id=" ougcfp1"="" name="cert[0][ocfp]" value="/userdocuments/registration/workexp/wc/1/0"><i class="fa fa-eye" style="color:white!important"></i></a></label></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="Land">
                                            </div>
                                        </div>
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified " id="tabs" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="tab3" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/assect_document_img1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="26"><b> Asset documents</b> <input type="checkbox" class="checkg" id="profile" name="nationality" value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="ls123">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label> Extend Of Land:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="20 meter">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control default" required id="asset_name" name="asset_name" value="2000-12-02">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="otherowner">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="Raju">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Relation to the Asset's Owner :<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" value="Son">
                                            </div>
                                        </div>
                                        <!-- </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Date of Birth :<span class="error-star" style="color:red;">*</span></label>
                                                <input type="date" class="form-control default" required id="asset_name" name="asset_name" value="1998-01-08">
                                            </div>
                                        </div>
                                ...
                                <div class="section-body mt-1">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="egc" style="display: flex;  align-items: center;">
                                                    ...
                                                    <div class="switch-field" style="padding-left:12px">
                                                        <input type="radio" id="radio-one13" name="wrqch" readonly value="yes" required onchange="radchange(this)" />
                                                        <label for="radio-one13">Yes</label>
                                                        <input type="radio" id="radio-two13" name="wrqch" readonly value="no" required onchange="radchange(this)" />
                                                        <label for="radio-two13">No</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" id="otherowner">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label> Name:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" readonly value="Raju">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Relation to the Asset's Owner :<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="asset_name" name="asset_name" readonly value="Son">
                                            </div>
                                        </div>
                                        <!-- </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Date of Birth :<span class="error-star" style="color:red;">*</span></label>
                                                <input type="date" class="form-control default" required id="asset_name" name="asset_name" readonly value="1998-01-08">
                                            </div>
                                        </div>

                                    </div>
                                    <input type="hidden" name="attachment_counte" id="attachment_counte" readonly value="1">
                                    <div id="dynamic_fielde"></div>
                                    <button type="button" name="adde" id="adde" class="btn btn-primary" style="background-color: #1d90cb !important">Add </button>

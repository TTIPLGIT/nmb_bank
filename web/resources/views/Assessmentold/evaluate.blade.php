                ...
                <form method="POST" id="generalupdate_form" enctype="multipart/form-data">
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/evaluate1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="36"><b>Evaluate</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Size of the plot:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Total Extend of the plot:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Prevailing market rate:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Guideline Rate obtained from Register office:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Assessed/adopted rate of valuation:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Estimate Value of the Land:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">

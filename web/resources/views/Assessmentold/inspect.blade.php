                ...
                <form method="POST" id="generalupdate_form" enctype="multipart/form-data">
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/inspect1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="36"><b>Report Inspection</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Date of Inspection Report:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="date" class="form-control default" required id="doi" name="doi" data-date-format="DD/MM/YYYY" readonly value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Boundaries of the property:<span class="error-star" style="color:red;">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Extent of the site:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Develpoment of Surrounding Area:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Feasibility to the Civic amenities:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Classification of locality:<span class="error-star" style="color:red;">*</span></label>
                                                <select type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                                    <option value="Residential">Select-Locality</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Water potentiality:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Underground sewerage system:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Power supply available in the site:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Advantage of the site:<span class="error-star" style="color:red;">*</span></label>
                                                <textarea type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="Principal Valuer">
                                                </textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Disadvantage of the site:<span class="error-star" style="color:red;">*</span></label>
                                                <textarea type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="Principal Valuer">
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>General remarks if any:<span class="error-star" style="color:red;">*</span></label>
                                                <textarea type="text" class="form-control default" required id="Address_line1" name="Address_line1" value="Principal Valuer">
                                                </textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <label>External Inspection Report:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="file" class="form-control default" required id="Address_line1" name="Address_line1" value="Principal Valuer">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <label>Internal Inspection Report:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="file" class="form-control default" required id="Address_line1" name="Address_line1" value="Principal Valuer">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        cd = today.toISOString().slice(0,10);

        document.getElementById('doi').value = cd;

...
<div class="main-content">
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
            ...
            {{ Breadcrumbs::render('vrallocation') }}
                <form method="POST" id="generalupdate_form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <div id="previousnotes">
                                                        ...
                                                        <div class="form-group scroll_flow_class">
                                                            ...
                                                            <span>15/03/2022 15:40:17 - Approved </span> <br>
                                                            <span> Notes - Reviewed all Details</span> <br><br>

                                                            <span> Prinicipal Valuer (Richard) - Reviewed </span> <br>

                                                            <span>15/03/2022 15:40:17 - Due diligence </span> <br>
                                                            <span> Notes - Verified all documents</span> <br><br>
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/allocate1.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="35" height="36"><b> Allocate</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                ...
                                <div class="section-body mt-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Target Completion Date:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="Date" class="form-control default" required id="target_completeion_date" name="target_completeion_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Search By Register Number:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="Text" class="form-control default" required id="searchbyname" name="searchbyname">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Search By Rating:<span class="error-star" style="color:red;">*</span></label>
                                                <Select class="form-control default" required id="equity" name="equity">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" style="margin-top: 30px;">
                                                <input type="number" class="form-control default" max="5" min="0" step="0.1" inputmode="" required id="target_completeion_date" name="target_completeion_date">

                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group" style="margin-top: 30px;">
                                                <input type="number" class="form-control default" max="5" min="0" step="0.1" required id="target_completeion_date" name="target_completeion_date">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Search By Name:<span class="error-star" style="color:red;">*</span></label>
                                                <input type="Text" class="form-control default" required id="searchbyname" name="searchbyname">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>Search By No of Assets Valued:<span class="error-star" style="color:red;">*</span></label>
                                                <Select class="form-control default" required id="equity1" name="equity1" onchange="readonly()">
                                                    <option>Select-Equity</option>
                                                    <option>Greater than</option>
                                                    <option>Lesser than</option>
                                                    <option>Equal to</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" style="margin-top: 30px;">
                                                <input type="number" class="form-control default" required id="target_completeion_date" min="0" name="target_completeion_date">
                                    ...
                                    <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%">S.No</th>
                                                <th style="width: 25%">Primary Valuer Name</th>
                                                <th style="width: 25%">No of Assets Valued</th>
                                                <th style="width: 20%">Ratings out of 5</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="trc">
                                                <td>1</td>
                                                <td style="word-break: break-all;">Mathew</td>
                                                <td> 23</td>
                                                ...
                                                <td><a class="btn  btn-info" href="{{ route('vrallocation','1') }}" title="Allocation" style="color:white">Allocate</i></a></td>
                                            </tr>
                                            <tr class="trc">
                                                <td>2</td>
                                                <td style="word-break: break-all;">Henry</td>
                                                <td> 32 </td>
                                            ...
                                            <tr class="trc">
                                                <td>3</td>
                                                <td style="word-break: break-all;">Richard</td>
                                                <td>12 </td>
                                            ...
                                            <tr class="trc">
                                                <td>4</td>
                                                <td style="word-break: break-all;">Samuel</td>
                                                <td> 78 </td>
                                            ...
                                            <tr class="trc">
                                                <td>5</td>
                                                <td style="word-break: break-all;">Allen</td>
                                                <td> 55 </td>
                                            ...
                                            <tr class="trc">
                                                <td>6</td>
                                                <td style="word-break: break-all;">Smith</td>
                                                <td> 103 </td>
                                            ...
                                            <tr class="trc">
                                                <td>7</td>
                                                <td style="word-break: break-all;">Riyaz</td>
                                                <td> 89 </td>
                                            ...
                                            <tr class="trc">
                                                <td>8</td>
                                                <td style="word-break: break-all;">Adam</td>
                                                <td> 132 </td>

                                ...
                                <div class="section-body mt-1">
                                    ...
                                    <div id="dynamic_fielddip">
                                        <section class="input-box dip" id="rowdip">
                                            @foreach($rows['education_edit'] as $data)
                                            <div class="educationdip">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Course Type:<span class="error-star" style="color:red;">*</span></label>
                                                            <select class="form-control crsdip" id="course_typedip" name="course_typedip" disabled>
                                                                <option value="{{$data['graduation']}}">{{$data['graduation']}}</option>
                                                                <option value="Diploma">Diploma</option>
                                                                <option value="Under Graduation">Undergraduate</option>
                                                                <option value="Post Graduation">Postgraduate</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control unidip" id="university_namedip" name="university_name" readonly value="{{$data['university_name']}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control crsdip" id="course_namedip" name="course_name" disabled>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="month" class="form-control ypdip month_date" maxlength="5" id="yopdip" name="yop" max="2023-06" readonly value="{{$data['yop']}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>CGPA:<span class="error-star" style="color:red;">*</span></label>
                                                            <input type="number" min="1" max="5" class="form-control mkdip validate no-arrows" id="m_percentagedip" name="m_percentage" readonly value="{{$data['m_percentage']}}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 d-flex flex-column">
                                                            <label><b>Graduation Certificate:</b>
                                                                <span class="error-star" style="color:red;">*</span></label>
                                                            <span class="file_color d-flex align-items-baseline" id="document" name="" value="" accept=".pdf, .doc, .png," disabled autocomplete="off"><b>{{$data['graduationcertifiname']}}</b>
                                                                <div class="form-group">
                                                                    <div class="dropdown show">
                                                                        <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" title="Graduation Certificate" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                            ...
                                                                        </a>

                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument('{{$data['graduationcertifipath']}}/{{$data['graduationcertifiname']}}')">View</a>
                                                                        <a type="button" class="dropdown-item " title="Download Documents" href="{{$data['graduationcertifipath']}}/{{$data['graduationcertifiname']}}" download>Download</a>

                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </span>
                                                            <input type="hidden" name="graduationcertifiname" value="{{$data['graduationcertifiname']}}">
                                                            <input type="hidden" name="graduationcertifipath" value="{{$data['graduationcertifipath']}}">
                                                        ...
                                                        <!-- <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Other Documents:
                                                                        <span class="error-star" style="color:red;">*</span></label>
                                                                    <span class="file_color" id="document" name="" value="" accept=".pdf, .doc, .png," disabled autocomplete="off"><b>{{$data['otherdocuments_name']}}</b></span>
                                                                    <input type="hidden" name="otherdocuments_name" value="{{$data['otherdocuments_name']}}">
                                                                    <input type="hidden" name="otherdocuments_path" value="{{$data['otherdocuments_path']}}">
                                                                    <a type="button" class="btn btn-success " title="Download Documents" href="{{$data['otherdocuments_path']}}/{{$data['otherdocuments_name']}}" download><i class="fa fa-download" style="color:white!important"></i></a>
                                                                    <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument('{{$data['otherdocuments_path']}}/{{$data['otherdocuments_name']}}')"><i class="fa fa-eye" style="color:white!important"></i></a>


                                                                </div>
                                                            </div> -->

                                                            @if($data['otherdocuments_name'] !="")

                                                        <div class="col-md-6 d-flex flex-column">
                                                            <label><b>Other Documents</b> </label>
                                                            <span class="file_color d-flex align-items-baseline" id="document" name="" value="" accept=".pdf, .doc, .png," disabled autocomplete="off"><b>{{$data['otherdocuments_name']}}</b>
                                                                <div class="form-group">
                                                                    <div class="dropdown show">
                                                                        <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" title="Otherdocuments" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                            ...
                                                                        </a>

                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument('{{$data['otherdocuments_path']}}/{{$data['otherdocuments_name']}}')">View</a>
                                                                        <a type="button" class="dropdown-item " title="Download Documents" href="{{$data['otherdocuments_path']}}/{{$data['otherdocuments_name']}}" download>Download</a>
...
<script type="application/javascript">
    ...
    $("#addug").click(function(e) {
        ...
        $('#dynamic_fieldug').append(
            ...
            '<input type="file" accept=".pdf, .doc, .png," class="form-control ccug mb-0" id="consolidate_markug" name="ug[' + i + '][consolidate_mark]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<div class="col-md-4">' +
            '<div class="form-group">' +
            '<label>Other Documents:</label>' +
            '<input type="file" accept=".pdf, .doc, .png," class="form-control gcug mb-0" id="garduation_certificateug" name="ug[' + i + '][garduation_certificate]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<div>' +
    ...
    $("#addpg").click(function(e) {
        ...
        $('#dynamic_fieldpg').append(
            ...
            '<div class="form-group">' +
            '<label>Graduation Certificate:<span class="error-star" style="color:red;">*</span></label>' +
            '<input type="file" accept=".pdf, .doc, .png," class="form-control ccpg mb-0" id="consolidate_markpg" name="pg[' + j + '][consolidate_mark]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<div class="col-md-4">' +
            '<div class="form-group">' +
            '<label>Other Documents:</label>' +
            '<input type="file" accept=".pdf, .doc, .png," class="form-control gcpg mb-0" id="garduation_certificatepg" name="pg[' + i + '][garduation_certificate]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<button style="margin-top:30px" type="button" name="remove" id="ug" value=' + i + ' class="btn btn-danger btn_removeug btn_create">X</button>' +
    ...
    $("#adddip").click(function(e) {
        ...
        $('#dynamic_fielddip').append(
            ...
            '<div class="form-group">' +
            '<label>Graduation Certificate:<span class="error-star" style="color:red;">*</span></label>' +
            '<input type="file" accept=".pdf, .doc, .png," class="form-control ccdip mb-0" id="consolidate_markdip" name="dip[' + k + '][consolidate_mark]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<div class="col-md-4">' +
            '<div class="form-group">' +
            '<label>Other Documents:</label>' +
            '<input type="file" accept=".pdf, .doc, .png," class="form-control gcdip mb-0" id="garduation_certificatedip" name="dip[' + k + '][garduation_certificate]">' +
            '<strong style="color: red;">Following files could be uploaded pdf,doc,png</strong>' +
            '</div>' +
            '</div>' +
            '<div>' +
...
<script>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                $("#loading_gif").hide();
                var proposaldocuments = "<div class='removeclass' style='height:100%'><iframe src='" + data + "' class='document_iframe_view' style='width:100%; height:100%'></iframe></div>";
                $('.removeclass').remove();
...
<script>
    $(document).ready(function() {
        var dropdownElement = document.querySelectorAll('.btn.dropdown-toggle');
        for (var i = 0; i < dropdownElement.length; i++) {
            dropdownElement[i].classList.remove('dropdown-toggle');
        }

    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
            <div class="" style="height:100%; padding: 15px">
                ...
                @endforeach
                {{ Breadcrumbs::render('Registration.show',$id) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " required id="Address_line1" name="Address_line1" readonly value="{{$data['Address_line1']}}">
                                            </div>
                                        </div>
                                        <!-- </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " required id="district" name="district" disabled>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " required id="constituency" name="constituency" disabled>
                                                    <option value="{{$data['constituency']}}">{{$data['constituency_name']}}</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " required id="village" name="village" disabled>
                                                    <option value="{{$data['village']}}">{{$data['village_name']}}</option>
                                        ...
                                        <div class="col d-flex justify-content-between">
                                            <div class="col-12 d-flex align-items-baseline ml-4" style="gap:10px">
                                                <input type="radio" disabled id="nin" name="document_type"  value="nin" class="nin" {{$data['document_type'] == 'nin' ? "checked" : ""}}>
                                                <label class="fw-light" for="nin">NIN</label>
                                                <input type="radio" disabled id="passport" name="document_type" value="passport" class="passport" {{$data['document_type'] == 'passport' ? "checked" : ""}}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="display:flex;justify-content: space-between;">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control " maxlength="12" value="{{$data['nin']}}" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required id="nin" name="nin">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">

...
<script>
    ...
    //     if (cons == '') {
    //         swal.fire("Please Select the Constituency", "", "error")
    //         return false;
    //     }

    //     var vill = $("#village").val();
    //     if (vill == '') {
    //         swal.fire("Please Select the Village", "", "error")
    //         return false;
    //     }
                                ...
                                <div class="section-body mt-0">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            @if($rows['general'] == [])
                                            <a type="button" style="font-size:15px;" class="btn btn-success btn-lg mb-2 ml-2" title="Create" id="gcb" href="{{ route('Registration.create') }}" data-toggle="modal" data-target="#addModal">Add General Details <i class="fa fa-plus" aria-hidden="true"></i></a>
                                            @endif
                                            <div class="card mt-0">
                                                <div class="card-body">
                                                            ...
                                                            <table class="table table-stripped" id="align7">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ ($data['constituency_name'] !=null) ? $data['constituency_name'] : '-' }}</td>
                                                                        <td>{{ ($data['village_name'] !=null) ? $data['village_name'] : '-' }}</td>
                                                                        <!-- <td>{{$data['nin']}} </td> -->
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form action="{{ route('destroygen',$id) }}" id="destroygen" method="POST">

                                                                                <a class="btn btn-link" title="Edit" href="{{ route('Registration.edit',$id) }}"><i class="fas fa-pencil-alt" style="color: blue !important"></i></a>
                                                                                <a class="btn btn-link" title="show" href="{{ route('Registration.show',$id) }}"><i class="fas fa-eye" style="color:green"></i></a>
                                                                                @method('put')
                                                                                @csrf
...
<script>
    function delete1() {
        Swal.fire({
            title: "Are you sure, you want to delete the General Details?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.value) {
                            Swal.fire("Success!", "General Details Deleted Successfully!", "success").then((result) => {

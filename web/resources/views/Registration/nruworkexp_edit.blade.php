                ...
                <form action="{{ route('nrustore') }}" method="POST" id="nrueducreate_form" enctype="multipart/form-data">
                                        ...
                                        <div class="row flex">
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control default  wrq" min="1" placeholder=" Enter the Experience" type="number" id="experience" name="experience" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " type="file" id="certd" name="cert[0][certd]" value="" accept=".pdf, .doc, .png," autocomplete="off">
                    ...
                    <div style="display:flex; justify-content:center; width:100%">
                        ...
                        <button onclick="nruexpcre()" id="registerbutton" class="btn btn-labeled btn-info" title="Submit" style="background: green !important; border-color:green !important; color:white !important;  margin-top:15px !important; margin-left:15px !important;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-check"></i></span>Save</a></button>

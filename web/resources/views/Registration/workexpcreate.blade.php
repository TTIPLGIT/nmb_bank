    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
                        ...
                        <div id="tab1">
                            <section class="section">
                                <div class="section-body mt-1">
                                    <!-- <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">Education level:<span class="error-star" style="color:red;">*</span></label>
                                                <input class="form-control default" type="text" id="edu_lvl" name="edu_lvl" autocomplete="off" value="Masters" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control default" type="text" id="we" name="we" value="" autocomplete="off">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="egc" style="display: flex;  align-items: center;">
                                                    <div class="dq"><span class="questions">Work Experience: YES/NO:</span></div>

                                                    <div class="switch-field" style="padding-left:12px">
                                                        <input type="radio" id="radio-one12" name="wrqch" value="yes" onchange="radchange(this)" />
                                                        <label for="radio-one12">Yes</label>
                                                        <input type="radio" id="radio-two12" name="wrqch" value="no" onchange="radchange(this)" />
                                    ...
                                    <div class="note">
                                        <span><b>Hints:</b>
                                            <h6 class="ml-5">Yes-Expericened/No-Fresher.</h6>
                                        </span>
                                    </div>
                                    <div class="" id="qv1">
                                        <div class="row flex">
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control default  wrq" min="2" placeholder="Experience" type="number" id="experience" name="experience" autocomplete="off" readonly>
                                        ...
                                        <div class="row flex">
                                            ...
                                            <div class="col-md-2 date_pic">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control default wrq dob fde_0 startdate fde" type="text" oninput="input(this)" onchange="yearcount(event)" title="fde" id="fde" name="wrq[0][fde_yes]" placeholder="DD-MM-YYYY" autocomplete="off">
                                            ...
                                            <div class="col-md-2 date_pic">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control default  wrq dob tde_0 tde" type="text" oninput="input(this)" onchange="yearcount(event)" id="tde" disabled name="wrq[0][tde_yes]" placeholder="DD-MM-YYYY" autocomplete="off">
                                    ...
                                    <div class="" id="qv2" style="display:none;">
                                        <div class="row" style="display:none;">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">From Date:<span class="error-star" style="color:red;">*</span></label>
                                                    <input class="form-control default  wre fde_wre dob startdate" value=" " type="text" oninput="input(this)" id="fde" name="wre[0][fde]" placeholder="DD-MM-YYYY" autocomplete="off">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">To Date:<span class="error-star" style="color:red;">*</span></label>
                                                    <input class="form-control default  wre tde_wre dob startdate" type="text" value="" oninput="input(this)" id="tde" name="wre[0][tde]" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-0" type="file" id="certd" name="cert[0][certd]" value="" accept=".pdf,.png," autocomplete="off">
            ...
            <div style="display:flex; justify-content:center; width:100%">
                ...
                <button onclick="expcre()" id="registerbutton" class="btn btn-labeled btn-info form_submit_handle" title="Submit" style="background: green !important; border-color:green !important; color:white !important;  margin-top:15px !important; margin-left:15px !important;">
...
<script type="application/javascript">
    ...
    function date_picker() {
        ...
        $j(".fde").datepicker({
            ...
            onSelect: function(selectedDate) {
                ...
                const $tde = $j(this).closest(".date_pic").next().find(".tde");
    ...
    $("#addc").click(function() {
        ...
        var q = j + 1;
        // $('#dynamic_field').append('<div id="row'+i+'"><div class=""><input type="text" name="name[]" placeholder="Enter your Name" class="form-control name_list"/></td><td><input type="text" name="email[]" placeholder="Enter your Email" class="form-control name_email"/></td><td></div>');  
        $('#dynamic_fieldc').append('<section class="input-box" id="row' + j + '"><div class="row clear remove_other' + j + ' align-items-center"><div class="col-md-4"> <div class="form-group"> <label class="control-label">Name of the Professional Body:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default" type="text" placeholder="Enter the Professional Body" id="nopb" name="cert[' + i + '][nopb]" autocomplete="off" required value="" > </div> </div> <div class="col-md-3"> <div class="form-group"> <label class="control-label">Certificate issued by:<span class="error-star" style="color:red;">*</span></label> <input class="form-control default" type="text" id="certib" name="cert[' + i + '][ib]" placeholder="Enter the Certificate issued By" required value="" autocomplete="off">  </div> </div> <div class="col-md-4"> <div class="form-group"> <label class="control-label">Certification Documents:<span class="error-star" style="color:red;">*</span></label> <input class="form-control" type="file" id="certd" accept=".pdf,.png," name="cert[' + i + '][certd]" required value="" autocomplete="off"> </div> </div> <div><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove">X</button></div></div></section>');
        i++;
    ...
    $("#addcompany").click(function() {
        var i = document.querySelectorAll('#C_name').length;
        ...
        // }
        var $j = jQuery.noConflict();
        var lastTDEDate = $j(".tde:last").datepicker("getDate");

        // $('#dynamic_field').append('<div id="row'+i+'"><div class=""><input type="text" name="name[]" placeholder="Enter your Name" class="form-control name_list"/></td><td><input type="text" name="email[]" placeholder="Enter your Email" class="form-control name_email"/></td><td></div>');    
        $('#dynamic_addc').append('<section class="input-box" id="row' + j + '"><div class="row clear remove_other' + j + '"><div class="row"><div class="col-md-3"><div class="form-group"><label class="control-label">Company Name<span class="error-star" style="color:red;">*</span></label><input class="form-control default  wrq" placeholder="Enter the Company name" type="text" id="C_name" name="wrq[' + i + '][C_name]" autocomplete="off" required value=""></div></div>  <div class="col-md-3"><div class="form-group"><label class="control-label">Designation<span class="error-star" style="color:red;">*</span></label><input class="form-control default wrq" type="text" placeholder="Enter the designation" id="designation_valuation" name="wrq[' + i + '][designation_valuation]" value="" autocomplete="off"></div></div><div class="col-md-2 date_pic"> <div class="form-group"> <label class="control-label">From Date:<span class="error-star" style="color:red;">*</span></label><input class="form-control default startdate fde wrq dob fde_' + i + '"  value="" type="text" oninput="input(this)" onchange="yearcount(event)" id="fde' + i + '" name="wrq[' + i + '][fde_yes]"  placeholder="DD-MM-YYYY" autocomplete="off"></div></div><div class="col-md-2 date_pic"><div class="form-group"><label class="control-label">To Date:</label><input class="form-control default startdate wrq tde dob tde_' + i + '" type="text" oninput="input(this)" onchange="yearcount(event)" placeholder="DD-MM-YYYY" id="tde' + i + '" value="" name="wrq[' + i + '][tde_yes]" required autocomplete="off"></div></div><div class="col-md-3"><div class="form-group"><label class="control-label"><span id="item_label"></span>Scope & Responsibilities:<span class="error-star" style="color:red;">*</span></label><div class="d-flex align-items-center" style="gap:5px"><textarea rows="10" columns="10" placeholder="Scope & Responsibilities" class="form-control default wre" type="text" id="aow" name="wrq[' + i + '][scope]" autocomplete="off"></textarea><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove_company">X</button></div></div></div></section>');
        i++;

        $("#attachment_counter").val(i);

        $j(".fde:last").datepicker({
            dateFormat: "dd-mm-yy",
            maxDate: 0,
            changeYear: true,
            onSelect: function(selectedDate) {
        ...
        if (lastTDEDate) {
            $j(".fde:last").datepicker("option", "minDate", lastTDEDate);
        }

        // $j(".tde:last").datepicker({
        //     dateFormat: "dd-mm-yy",
        //     maxDate: 0,
        //     changeYear: true,
        //     beforeShowDay: function(date) {
...
<script>
    function expcre() {
        ...
        var no_exist = $('#radio-two12').prop("checked");
        //yes
        if (no_exist == false) {

                ...
                <form action="{{ route('Registration.update',$user_id) }}" method="POST" id="eduedit_form" enctype="multipart/form-data">
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified " id="tabs" role="tablist" style="background-image: none;">
                            ...
                            <li class="nav-items navv" class="" style="flex-basis: 1 !important;">
                                <a class="nav-link" id="pg-tab" name="tab3" data-toggle="tab" role="tab" aria-controls="pg" aria-selected="false"><i class="fas fa-map-signs"></i> <b>Post Graduation</b> <input type="checkbox" class="checkg" id="adddetails" name="nationality" value="0" onchange="submitval(this)" style="background-color:solid green !important; color:green !important; visibility:hidden !important; "></a>
...
<script type="application/javascript">
    $(document).ready(function() 
    {
        ...
        for (i = 0; i < eul;) {
            ...
            $('#dynamic_fieldug').append('<section class="input-box ug" name="a" id="' + ugrow + '"><div class="educationug"> <div class="row"> <div class="col-md-4"><div class="form-group"><label>Graduation:<span class="error-star" style="color:red;">*</span></label><input type="text" class="form-control gradug" required id="graduationug" name="ug[' + i + '][graduation]"  value="Under Graduate" readonly> </div></div> <div class="form-group"> <label>Institution Name:<span class="error-star" style="color:red;">*</span></label> <input type="text" class="form-control uniug" required id="university_nameug" name="ug[' + i + '][university_name]" readonly value="' + education['ug'][i]['university_name'] + '"> </div> </div> </div> <div class="row"> <div class="col-md-4"> <div class="form-group"> <label> Course Name:<span class="error-star" style="color:red;">*</span></label> <select class="form-control crsug" required id="course_nameug" name="ug[' + i + '][course_name]" disabled> <option value="' + education['ug'][i]['course_name'] + '">' + education['ug'][i]['course_name'] + '</option> <option value="civil">civil</option> <option value="architect">architect</option> <option value="townplanning">townplanning</option> </select> </div> </div> <!-- </div> <div class="row"> --> <div class="col-md-4"> <div class="form-group"> <label> Completion Year <span class="error-star" style="color:red;">*</span></label> <input type="month" class="form-control ypug" maxlength="18" required id="yopug" name="ug[' + i + '][yop]" value="' + education['ug'][i]['yop'] + '" readonly> </div> </div> <div class="col-md-4"> <div class="form-group"> <label> CGPA %:<span class="error-star" style="color:red;">*</span></label> <input type="text" class="form-control mkug" required id="m_percentageug" name="ug[' + i + '][m_percentage]" value="' + education['ug'][i]['m_percentage'] + '" readonly> </div> </div> </div> <div class="row"> <h style="color:black"><b>Supporting Documents:</b></h></div><div class="row"> <div class="col-md-4"> <div class="form-group"> <label> Graduation Certificate: <span class="error-star" style="color:red;">*</span></label> <label>' + education['ug'][i]['cfn'] + '</label></div></div></div> <div class="row"> <div class="col-md-2"> <div class="form-group "> <label> <a type="button" class="btn btn-success " title="Download Documents" href="' + education['ug'][i]['cfp'] + '/' + education['ug'][i]['cfn'] + '" download><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument(' + docugc + ')"><i class="fa fa-eye" style="color:white!important"></i></a></div></div><div class="col-md-2">  </div><div class="col-md-2 dccug"  id="dconsolidate_markug' + r + '"><input type="file" class="form-control ccug"  id="consolidate_markug' + r + '" name="ug[' + i + '][consolidate_mark]"></div> </div> </div> <!-- </div> <div class="row"> --> <div class="col-md-4"> <div class="form-group"> <label> Other Documents:</label><label>' + education['ug'][i]['gfn'] + '</label></div></div></div> <div class="row"> <div class="col-md-2"> <div class="form-group "> <label> <a type="button" class="btn btn-success " title="Download Documents" href="' + education['ug'][i]['gfp'] + '/' + education['ug'][i]['gfn'] + '" download><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument(' + docugg + ')"><i class="fa fa-eye" style="color:white!important"></i></a></div></div><div class="col-md-2">  </div> <div class="col-md-2 dgcug"  id="dgarduation_certificateug' + r + '"> <input type="file" class="form-control gcug"  id="garduation_certificateug' + r + '" name="ug[' + i + '][garduation_certificate]"></div> </div> </div> <div></div> </div></div></section>');
            i++;
        ...
        for (j = 0; j < epl;) {
            ...
            $('#dynamic_fieldpg').append('<section class="input-box pg" id="' + pgrow + '"><div class="educationpg"> <div class="row"> <div class="col-md-4"><div class="form-group"><label>Graduation:<span class="error-star" style="color:red;">*</span></label><input type="text" class="form-control gradpg" required id="graduationpg" name="pg[' + j + '][graduation]" value="Post Graduation" readonly> </div></div> <div class="col-md-4"> <div class="form-group"> <label>Institution Name:<span class="error-star" style="color:red;">*</span></label> <input type="text" class="form-control unipg" required id="university_namepg" name="pg[' + j + '][university_name]" value="' + education['pg'][j]['university_name'] + '" readonly> </div> </div> </div> <div class="row"> <div class="col-md-4"> <div class="form-group"> <label> Course Name:<span class="error-star" style="color:red;">*</span></label> <select class="form-control crspg" required id="course_namepg" name="pg[' + j + '][course_name]" disabled> <option value="' + education['pg'][j]['course_name'] + '">' + education['pg'][j]['course_name'] + '</option> <option value="civil">civil</option> <option value="architect">architect</option> <option value="townplanning">townplanning</option> </select> </div> </div> <!-- </div> <div class="row"> --> <div class="col-md-4"> <div class="form-group"> <label> Completion Year  <span class="error-star" style="color:red;">*</span></label> <input type="month" class="form-control yppg" maxlength="18" required id="yoppg" name="pg[' + j + '][yop]" value="' + education['pg'][j]['yop'] + '" readonly> </div> </div> <div class="col-md-4"> <div class="form-group"> <label> CGPA %:<span class="error-star" style="color:red;">*</span></label> <input type="text" class="form-control mkpg" required id="m_percentagepg" name="pg[' + j + '][m_percentage]" value="' + education['pg'][j]['m_percentage'] + '" readonly> </div> </div> </div> <div class="row"> <h style="color:black"><b>Supporting Documents:</b></h></div><div class="row"> <div class="col-md-4"> <div class="form-group"> <label> Graduation Certificate: <span class="error-star" style="color:red;">*</span></label> <label>' + education['pg'][j]['cfn'] + '</label></div></div></div> <div class="row"> <div class="col-md-2"> <div class="form-group "> <label> <a type="button" class="btn btn-success " title="Download Documents" href="' + education['pg'][j]['cfp'] + '/' + education['pg'][j]['cfn'] + '" download><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument(' + docpgc + ')"><i class="fa fa-eye" style="color:white!important"></i></a></div></div><div class="col-md-2">  </div><div class="col-md-2 dccpg"  id="dconsolidate_markdip' + r + '"> <input type="file" class="form-control ccpg"  id="consolidate_markpg' + r + '" name="pg[' + j + '][consolidate_mark]"> </div></div> </div> <!-- </div> <div class="row"> --> <div class="col-md-4"> <div class="form-group"> <label> Other Documents:<span class="error-star" style="color:red;">*</span></label> <label>' + education['pg'][j]['gfn'] + '</label></div></div></div> <div class="row"> <div class="col-md-2"> <div class="form-group "> <label> <a type="button" class="btn btn-success " title="Download Documents" href="' + education['pg'][j]['gfp'] + '/' + education['pg'][j]['gfn'] + '" download><i class="fa fa-download" style="color:white!important"></i></a> <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument(' + docpgg + ')"><i class="fa fa-eye" style="color:white!important"></i></a></div></div><div class="col-md-2">  </div><div class="col-md-2 dgcpg"  id="dgarduation_certificatedip' + r + '"> <input type="file" class="form-control gcpg"  id="garduation_certificatepg' + r + '" name="pg[' + j + '][garduation_certificate]"></div> </div> </div> <div></div> </div></div></section>');
            j++;
        ...
        swal({
            ...
            function(isConfirm) {
                ...
                if (isConfirm) {
                    ...
                    swal("Deleted!", "Respective Data are deleted successfully !", "success");

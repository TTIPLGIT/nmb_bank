            ...
            <div class="" style="height:100%; padding: 15px">
                ...
                <form action="{{ route('Registration.store') }}" method="POST" id="educreate_form" enctype="multipart/form-data">
                                    ...
                                    <div id="dynamic_fielddip">
                                        <section class="input-box dip" id="rowdip">
                                            <div class="educationdip">
                                                @foreach($rows['education_details_new'] as $data)
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control unidip" id="university_namedip" name="university_name" value="{{$data['university_name']}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="month" class="form-control ypdip month_date" maxlength="5" id="yopdip" name="yop" max="2023-06" value="{{$data['yop']}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>CGPA</label>
                                                            <input type="number"  class="form-control mkdip validate no-arrows" id="m_percentagedip" name="m_percentage" value="{{$data['m_percentage']}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 d-flex flex-column">
                                                            ...
                                                            <span class="file_color d-flex align-items-baseline" id="document" name="graduationcertifiname" value="" accept=".pdf, .png," disabled autocomplete="off"><b>{{$data['graduationcertifiname']}}</b>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="d-none" id="graduatef1">
                                                                <input class="form-control  mb-0" type="file" accept=".pdf, .png," id="graduatefile" name="graduationcertifipath" value="" autocomplete="off">
                                                        ...
                                                        <div class="col-md-6 d-flex flex-column">
                                                            ...
                                                            <span class="file_color d-flex align-items-baseline" id="document" name="" value="" accept=".pdf, .png," disabled autocomplete="off"><b>{{$data['otherdocuments_name']}}</b>
                                                                <div class="form-group">
                                                                    <div class="dropdown show">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                            ...
                                                                            <a type="button" class="dropdown-item  change_documents" id="f1" title="change Documents" value="1" onclick="otherdocumentchangefile1(this)">Change file</a>
                                                                            <input type="hidden" id="otherdoc1" name="otherdoc2" value="1">

                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </span>
                                                            <div class="d-none" id="graduatef2">
                                                                <input class="form-control  mb-0" type="file" accept=".pdf, .png," id="graduatefile2" name="otherdocuments" value="" autocomplete="off">
                                                                <strong style="color:red;">Following files could be uploaded pdf,png</strong>
                                                            </div>
                    ...
                    <div style="display:flex; justify-content:center; width:100%">
                        ...
                        <button onclick="educre()" id="registerbutton" class="btn btn-labeled btn-info" title="Submit" style="background: green !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
...
<script>
    function graduatechangefile1(a) {
        if ($(a).hasClass("change_documents")) {
            ...
            $('#graduatef1').removeClass('d-none');
        } else {
            $(a).text("Change file");
            $(a).removeClass("stay_same");
            $(a).addClass("change_documents");
            $('#graduatef1').addClass('d-none');
    ...
    function otherdocumentchangefile1(a) {
        if ($(a).hasClass("change_documents")) {
            $(a).text("Stay same");
            $(a).removeClass("change_documents");
            $(a).addClass("stay_same");
            $('#graduatef2').removeClass('d-none');
        } else {
            $(a).text("Change file");
            $(a).removeClass("stay_same");
            $(a).addClass("change_documents");
            $('#graduatef2').addClass('d-none');

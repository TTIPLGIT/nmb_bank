                ...
                <form action="{{ route('Registration.store') }}" method="POST" id="educreate_form" enctype="multipart/form-data">
                    ...
                    <div id="content">
                        ...
                        <div id="tab2">
                            ...
                            <div style="display:flex; justify-content:center; width:100%; gap:3.2px;">
                                ...
                                <a type="button" class="btn btn-labeled btn-info next_button" onclick="DoActions('tab3');" title="next" style="background: #4d94ff !important; border-color:#4d94ff !important; color:white !important;  margin-top:10px !important;  margin-left:10px;">
                                    <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-right"></i></span>Next</a>
                            </div>
                        </div>
                        <div id="tab3">

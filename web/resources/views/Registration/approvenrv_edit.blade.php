            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="background-color: #f8fffb !important;">
                        <form action="{{route('Registration.approvenrv_update')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>{{$data['']}}</label>
                                        <input type="hidden" name="filen" value="{{$data['approvedcertificateproofn']}}">
                                        <input type="hidden" name="filep" value="{{$data['approvedcertificateproofp']}}">
                                        <a type="button" class="btn btn-success " title="Download Documents" href="{{$data['approvedcertificateproofp']}}/{{$data['approvedcertificateproofn']}}" download><i class="fa fa-download" style="color:white!important"></i></a>
                                        <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onClick="getproposaldocument('{{$data['approvedcertificateproofp']}}/{{$data['approvedcertificateproofn']}}')"><i class="fa fa-eye" style="color:white!important"></i></a>

            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm border-0 rounded-4">
                        ...
                        <div class="card-body p-2 text-center" style="background-color: #f8f9fc;">
                            <object class="coursetypes" data="{{$courseIntroFullPath}}#toolbar=0" width="100%"
                                height="400" style="border-radius: 8px; border: 1px solid #ddd;">
                            </object>
                        </div>
                    </div> -->
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group quiz">
                            <label class="">No.of
                                Attempts:</label><span>{{isset($quiz_results[$classContent->quiz_id]) ? $quiz_results[$classContent->quiz_id]->attempt : '0'}}</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group quiz">
                            <label
                                class="">Score:</label><span>{{isset($quiz_results[$classContent->quiz_id]) ? $quiz_results[$classContent->quiz_id]->score : '-'}}</span>
                        </div>
                    </div>
                    <!-- <div class="col-md-4">
                        <div class="form-group quiz">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <a class="btn btn-primary" style="border-radius: 50px !important;background-color: darkblue;"
                            href="{{ route('class.class_quiz', ['course_id' => $classContent->course_id, 'class_id' => $classContent->class_id]) }}">Take
                            Quiz</a>
                    </div>
        ...
        <div class="card-body">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a class="btn btn-primary" style="border-radius: 50px !important;background-color: darkblue;"
                            href="{{ route('course.exam', ['course_id' => $classContent->course_id, 'class_id' => $classContent->class_id]) }}">Take
                            Exam</a>
                    </div>
                </div>
            </div>
...
<div class="container-fluid" id="overviewContent">
    ...
    <div class="card noShadow noBorder border-bottom classOverviewContent">
        <div class="card-body bgTransparent classOverviewContentBody">
            ...
            <input type="hidden" name="courseTags" class="courseTags" id="tags_{{$courseDetail->course_id}}"
                value="{{$courseDetail->course_tags}}" />
...
<div class="container-fluid py-3 px-5" id="qAndAContent" style="display: none;">
    ...
    <div class="forumQuestionView" id="forumQuestionView">
        <div class="row mb-4">
            ...
            <div class="col-10 questionSearchContainer">
                <div class="d-flex flex-row justify-content-center align-items-center">
                    <input type="search" class="form-control" id="questionSearch" name="questionSearch"
            ...
            <input type="hidden" name="question_id" id="question_{{ $askedQuestion->question_id }}" class="question_id"
                value="{{ $askedQuestion->question_id }}">
        ...
        <div class="question_container">
            ...
            <div class="card noShadow mx-4 border-0 postedQuestionWrapper"
                id="question_{{ $askedQuestion->question_id }}">
                <div class="row no-gutters" id="class_{{ $askedQuestion->class_id }}">
                    ...
                    <div class="col-md-10 pt-1">
                        ...
                        <input type="hidden" name="questionDescription"
                            id="description_{{ $askedQuestion->question_id }}" class="questionDescription"
                            value="{{ $askedQuestion->question_description }}">
                        <span style="overflow:hidden !important;" class="questionDescriptionHolder"
                            id="descriptionFor_{{ $askedQuestion->question_id }}">
                    ...
                    <div class="col-md-1 d-flex flex-column align-items-center">
                        ...
                        <i class="fa fa-plus-square-o followIcon {{$exist}} for_{{ $askedQuestion->question_id }}"
                            onclick="addfollowup('{{ $askedQuestion->question_id }}','{{ $askedQuestion->course_id }}');"
                            aria-hidden="true"><sup
                                class="badge badge-light bell_notification">{{$askedQuestion->number_of_follows}}</sup></i>
                        @else
                        <i class="fa fa-plus-square-o followIcon isYoursClass for_{{ $askedQuestion->question_id }} "
                            onclick="addfollowup('{{ $askedQuestion->question_id }}','{{ $askedQuestion->course_id }}');"
                            aria-hidden="true"><sup
                                class="badge badge-light bell_notification">{{$askedQuestion->number_of_follows}}</sup></i>
                        @endif
                        <i class="fa fa-reply replyIcon"
                            onclick="addreply('{{ $askedQuestion->question_id }}','{{ $askedQuestion->user_id }}')"
                            class="for_{{ $askedQuestion->question_id }}" aria-hidden="true"></i>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="forumQuestionCreation" id="forumQuestionCreation" style="display: none;">
        ...
        <div class="row">
            ...
            <form class="col-lg-12 addQuestionForm" id="course_add" action="{{ route('addQuestion',$id) }}"
                method="post">
                @csrf
                @method('GET')
                ...
                <button class="btn btn-success forumSubmit" type="button" id="submitRedirectButton"
                    onclick="course_submit()">Submit </button>
            </form>
            @endforeach
        </div>
    </div>
...
<div class="card noShadow mx-4 border-0 replypost" id="question_reply" style="display:none">
    ...
    <input type="hidden" name="courseId" class="courseId"
        value="{{ isset($askedQuestion->course_id) ? $askedQuestion->course_id :'' }}">
    ...
    <div class="row no-gutters" id="class_{{ isset($askedQuestion->class_id) ? $askedQuestion->class_id :''  }}">
        ...
        <div class="col-md-10 pt-1">
            ...
            <input type="hidden" name="questionDescription" id="qustion_reply_description" class="questionDescription"
                value="{{ isset($askedQuestion->question_description) ? $askedQuestion->question_description : '' }}">
            <span style="overflow:hidden !important;" class="qustion_reply_description"
                id="descriptionFor_{{ isset($askedQuestion->question_id) ? $askedQuestion->question_id : '' }}">
                <!-- Description will be appended -->
            ...
            <div>
                ...
                <a class="btn btn-success"
                    onclick="replysubmit('{{ isset($askedQuestion->question_id) ? $askedQuestion->question_id : '' }}','{{ isset($askedQuestion->course_id) ? $askedQuestion->course_id  :'' }}');">Submit</a>
...
<div class="container-fluid" id="ratingContent" style="display: none;">
    <div style="display: flex;justify-content: space-between;align-items: center;">
        ...
        $user_id=session('userID');
        $ratings_list = DB::select("SELECT r.*,u.name from elearning_ratings as r inner join users as u on
        u.id=r.user_id where r.course_id=$id and r.user_id=$user_id");

        @endphp
        @if(count($ratings_list)==0)
        <button class="btn btn-warning" type="button" style="border-radius: 20%;" data-toggle="modal"
            data-target="#addModal2"><i class="fa fa-star-o"></i><strong>Rating</strong></button>
        @endif
    </div>
    <div class="container">
        <div class="row">
                            ...
                            <div class="row rating-desc">
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <div class="progress progress-striped">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            ...
                                            style="width: {{ $average_ratting['five_star'] }}%">
                                            <span class="sr-only">{{ $average_ratting['five_star'] }}</span>
                                        </div>
                                        <span class="percentage_data"
                                            style="font-weight: bolder;position: absolute;left: 50%;">{{ $average_ratting['five_star'] }}%</span>
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"
                                            style="width: {{ $average_ratting['four_star'] }}%">
                                            <span class="sr-only">{{ $average_ratting['four_star'] }}</span>
                                        </div>
                                        <span class="percentage_data"
                                            style="font-weight: bolder;position: absolute;left: 50%;">{{ $average_ratting['four_star'] }}%</span>
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"
                                            style="width: {{ $average_ratting['three_star'] }}%">
                                            <span class="sr-only">{{ $average_ratting['three_star'] }}</span>
                                        </div>
                                        <span class="percentage_data"
                                            style="font-weight: bolder;position: absolute;left: 50%;">{{ $average_ratting['three_star'] }}%</span>
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-warning" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"
                                            style="width: {{ $average_ratting['two_star'] }}%">
                                            <span class="sr-only">{{ $average_ratting['two_star'] }}</span>
                                        </div>
                                        <span class="percentage_data"
                                            style="font-weight: bolder;position: absolute;left: 50%;">{{ $average_ratting['two_star'] }}%</span>
                                    </div>
                                </div>
                                <div class="col-xs-8 col-md-3">
                                    <div class="small-ratings">
                                ...
                                <div class="col-xs-8 col-md-9">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            ...
                                            style="width: {{ $average_ratting['one_star'] }}%%">
                                            <span class="sr-only">{{ $average_ratting['one_star'] }}%</span>
                                        </div>
                                        <span class="percentage_data"
                                            style="font-weight: bolder;position: absolute;left: 50%;">{{ $average_ratting['one_star'] }}%</span>
    ...
    <div class="modal fade modalreset" id="addModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="display:flex;justify-content: center;">
                    ...
                    <div class="rate">
                        <input type="radio" class="ratting_class" id="rating10" name="rating" value="5.0" /><label
                            for="rating10" title="5 stars"></label>
                        <input type="radio" class="ratting_class" id="rating9" name="rating" value="4.5" /><label
                            class="half" for="rating9" title="4 1/2 stars"></label>
                        <input type="radio" class="ratting_class" id="rating8" name="rating" value="4.0" /><label
                            for="rating8" title="4 stars"></label>
                        <input type="radio" class="ratting_class" id="rating7" name="rating" value="3.5" /><label
                            class="half" for="rating7" title="3 1/2 stars"></label>
                        <input type="radio" class="ratting_class" id="rating6" name="rating" value="3.0" /><label
                            for="rating6" title="3 stars"></label>
                        <input type="radio" class="ratting_class" id="rating5" name="rating" value="2.5" /><label
                            class="half" for="rating5" title="2 1/2 stars"></label>
                        <input type="radio" class="ratting_class" id="rating4" name="rating" value="2.0" /><label
                            for="rating4" title="2 stars"></label>
                        <input type="radio" class="ratting_class" id="rating3" name="rating" value="1.5" /><label
                            class="half" for="rating3" title="1 1/2 stars"></label>
                        <input type="radio" class="ratting_class" id="rating2" name="rating" value="1.0" /><label
                            for="rating2" title="1 star"></label>
                        <input type="radio" class="ratting_class" id="rating1" name="rating" value="0.5" /><label
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="ratings"
                        onclick="rating_store(event);">Submit</button>
                </div>
            </div>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.notes.length < 1) {
                    ...
                    document.querySelector(`#${activeMenu.id}Content #data-container`).innerHTML =
                        `<div class="col-md-12"><div  style="width: max-content;color:red;">There is no notes added for this course yet</div></div>`;
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(data) {
                        // alert('feef');
                        if (result.value) {
                            Swal.fire("Success!", "Class Completed Successfully!", "success").then((
                                result) => {

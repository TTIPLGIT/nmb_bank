...
<script>
    ...
    function course_delete(course_id) {
        //  alert(id);
        Swal.fire({
            title: "Are you you want to delete the Course?",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
...
<script>
    function gencre1(id) {
        ...
        if (id == "1") {
            ...
            const input_array = document.querySelectorAll('.course_certificate');
            ...
            const input_array2 = document.querySelectorAll('.course_exam');
...
<script>
    function updateEndDate() {
        ...
        const endDate = new Date(startDate.getTime() + (10 * 24 * 60 * 60 * 1000)); // Adding 10 days (10 * 24 * 60 * 60 * 1000 milliseconds)

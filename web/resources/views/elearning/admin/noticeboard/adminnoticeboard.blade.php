...
<div class="main-content main_contentspace">
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="" style="">{{ Breadcrumbs::render('adminnoticeboard') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control default" id="notice_name" name="notice_name">
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control default" id="notice_banner" name="notice_banner">
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control default" id="notice_author" name="notice_author">
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    </div>

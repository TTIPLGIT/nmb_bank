...
@section('content')
<style>
/* ========== ENHANCED STYLES - MATCHING ELEARNING VERSION ========== */
.modal-backdrop {
...
.overview_body .card:hover {
    transform: translateY(-5px);
    box-shadow: 0 10px 25px rgba(104, 14, 218, 0.15) !important;
}
                ...
                <div class="card noShadow">
                    <div class="card-body d-flex" style="align-items:center">
                        ...
                        <div class="justify-content-between align-items-center">
                            <span
                                class="overview_count">{{$count['total_course'][0]['numberofcourses'] ?? 0}}</span><br>
                            <span class="card-span">Total Courses</span>
                        </div>
                    </div>
                </div>
                <div class="card noShadow">
                    <div class="card-body d-flex" style="align-items:center">
                        <div style="width:40%">
                            <img class="overview_img" id="overview_img_exception"
                                src="{{asset('asset/image/completed.png')}}" alt="PIN Course" width="40%">
                        </div>
                        <div class="justify-content-between align-items-center">
                            <span
                                class="overview_count">{{$count['restricted_access'][0]['numberofcourses'] ?? 0}}</span><br>
                            <span class="card-span">PIN Course</span>
                        </div>
                    </div>
                </div>
                <div class="card noShadow">
                    <div class="card-body d-flex" style="align-items:center">
                        <div style="width:40%">
                            <img class="overview_img" id="overview_img_exception"
                                src="{{asset('asset/image/paid-ads.png')}}" alt="Non Certificate Course" width="40%">
                        </div>
                        <div class="justify-content-between align-items-center">
                            <span
                                class="overview_count">{{$count['Not_certificate_course'][0]['numberofcourses'] ?? 0}}</span><br>
                            <span class="card-span">Non Certificate Course</span>
                        </div>
                    </div>
                </div>
                <div class="card noShadow">
                    <div class="card-body d-flex" style="align-items:center">
                        <div style="width:40%">
                            <img class="overview_img" id="overview_img_exception"
                                src="{{asset('asset/image/awards.png')}}" alt="Certificate Course" width="40%">
                        </div>
                        <div class="justify-content-between align-items-center">
                            <span
                                class="overview_count">{{$count['certificate_course'][0]['numberofcourses'] ?? 0}}</span><br>
                            <span class="card-span">Certificate Course</span>
                        </div>
                    </div>
                </div>
            </div>

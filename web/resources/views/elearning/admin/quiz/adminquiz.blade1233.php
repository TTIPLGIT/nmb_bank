...
<div class="main-content main_contentspace">
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="" style="height:100%; padding: 15px">{{ Breadcrumbs::render('adminquiz') }}
                    ...
                    <div id="longquestionlist">
                        ...
                        <section class="section">
                            ...
                            <div class="section-body mt-0">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 style="margin-top:10px;">Long Question:</h2>
                                        <div class="card">
                                            <div class="card-body">
                                            ...
                                            <div class="section-body mt-0">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <h3 style="margin-top:10px;">MCQ:</h3>
                                                        <div class="card mt-0">
            ...
            <div  id="shortquestionlist">
                ...
                <section class="section">
                    ...
                    <div class="section-body mt-0">
                        <div class="row">
                            <div class="col-12">
                                <h3 style="margin-top:10px;">Short Question:</h3>
            ...
            <section class="section" id="truelist">
                <div class="section-body mt-1">
                    <div class="row">
                        <div class="col-12">
                            <h3 style="margin-top:10px;">True/False:</h3>
                            <div class="card mt-0">
            ...
            <section class="section5">
                <div class="section-body mt-1">
                    <div class="row">
                        <div class="col-12">
                            <h3 style="margin-top:10px;">Quiz:</h3>
                            <div class="card mt-0">
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                ...
                                <textarea id="quistion" name="quistion" rows="4" cols="90"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label><br>
                                <textarea id="quistion" name="quistion" rows="4" cols="70"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label><br>
                                <textarea id="quistions2" name="quistions2" rows="4" cols="90"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label><br>
                                <textarea id="quistion11" name="quistion11" rows="4" cols="90"></textarea>
                ...
                <form method="POST" class="longqustionsform">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Question Name:<span class="error-star" style="color:red;">*</span></label>
                                <input type="text" class="form-control default" value="Testquestion1" id="qname6" name="qname6">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label>
                                <textarea id="quistion" name="quistion" value="How to Set Width Ranges for Your CSS Media Queries?" rows="4" cols="50"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label>
                                <textarea id="quistions2" name="quistions2" value=" How to Set Width Ranges for Your CSS Media Queries?" rows="4" cols="50"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Question:<span class="error-star" style="color:red;">*</span></label>
                                <textarea id="quistion11" name="quistion11" rows="4" cols="50"></textarea>

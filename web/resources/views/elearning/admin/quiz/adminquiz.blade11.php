...
<div class="main-content main_contentspace">
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="" style=" padding: 15px">{{ Breadcrumbs::render('adminquiz') }}
            ...
            <section class="section5">
                <div class="section-body mt-1">
                    <div class="row">
                        <div class="col-12">
                            <h3 style="margin-top:10px;text-align:center;">Quiz List</h3>
                            <div class="card mt-0">
                                <div class="card-body">
                                    ...
                                    <div class="table-wrapper">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-triped" id="align1">
                                                <thead>
                                                    <tr>
                                                        <th>S.No</th>
                                                        <th>quiz Name</th>
                                                ...
                                                <tbody style="background-color: #cfe0e8;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="submit" title="Delete" onclick="" class="btn btn-link"><i class="far fa-trash-alt" style="color:red"></i></button>
...
<div class="modal fade" id="addModal1">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="validate" action="{{ route('quiz_store')}}" name="add_quiz" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body" style="background-color: #f8fffb !important;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control default" id="fname" name="quiz_name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> Question Type:<span class="error-star" style="color:red;">*</span></label>
                                <select class="form-control default" id="result" name="quiz_questions">
                                    <option value="">Question Type</option>
                                    <option value="1">Long Question</option>
                                    <option value="2">Multiple Choice Question(MCQ)</option>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <button class="btn btn-success btn-space" type="submit" onclick="gencre()" id="savebutton">Submit</button>
                            <input type="button" class="btn btn-danger" data-dismiss="modal" value="Cancel">
                        </div>
                    </div>
                </div>

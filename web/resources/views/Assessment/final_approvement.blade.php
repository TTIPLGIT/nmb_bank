    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12">
            <div class="main-content" style="height:100%; padding: 15px">
                ...
                <div id="assetshow">
                    ...
                    <div class="tile" id="tile-1" style="margin-top:10px !important;">
                        ...
                        <ul class="nav nav-tabs nav-justified tabs" id="tab" role="tablist">
                            ...
                            <li class="nav-items navv" class="active" style="flex-basis: 1 !important;">
                                <a class="nav-link  " id="home-tab" name="" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true"><img src="{{asset('assets/images/user-graduate-solid.svg')}}" style=" filter: invert(1) contrast(4.5);" alt="" width="20" height="30"><b> Graduate Trainee Education Details</b> <input type="checkbox" class="checkg" id="profile" name="nationality" readonly value="0" onchange="submitval(this)" readonly style="background-color:solid green !important; color:green !important; visibility:hidden !important; ">
                                    <div class="check"></div>
                                </a>
                                                ...
                                                <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="trc">
                                                            ...
                                                            <th style="width: 20%">{{$data['is_supervisor']==1 ? "Supervisor" : "counselor"}}</th>
                ...
                <form action="{{route('approvegt')}}" method="POST">
                    @csrf
                    <div class="row mt-4">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Critical Analysis Report</label>
                            </div>
                            <div class="form-group">
                                @foreach($rows['data4'] as $key=>$data)
                                <label>{{$data['file_name']}}</label>
                                @endforeach
                                <input type="hidden" name="oldninfn" value="">
                                <input type="hidden" name="oldninfp" value="">
                                @php $url=config('setting.base_url') . 'uploads/critical/' . $data['user_id'] . '/' . $data['file_name']; @endphp
                                <a type="button" class="btn btn-success " title="Download Documents" onclick="downloadFile('{{ $url }}')" download=""><i class="fa fa-download" style="color:white!important"></i></a>
                                <!-- <a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onclick="getproposaldocument('{{ $url }}')"><i class="fa fa-eye" style="color:white!important"></i></a> -->

                            </div>
                        </div>
                    </div>
                    <input type="hidden" class="form-control" required id="user_id" name="gt_id" value="{{$rows['general'][0]['id']}}">
                    <div style="display:flex; justify-content:center; align-items:baseline; width:100%">
                        ...
                        <button type="submit" class="btn btn-labeled btn-info" title="Update" style="background: green !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">

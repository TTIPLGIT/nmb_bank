      ...
      <section class="section">
        <div class="section-body">{{ Breadcrumbs::render('final_assesment') }}
          <div class="col-lg-12 text-center">
            <h4 style="color:darkblue;">Final Assesment List</h4>
          </div>
                      ...
                      <table class="table table-bordered" id="align">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a data_type='1' title="Approve" class="btn btn-link" data-id="{{$row['id']}}" href="{{route('final_approve', $row['id'])}}"><img src="{{asset('assets/images/stamp-solid.svg')}}" alt="" width="20" height="30"></a></td>
                            @elseif($row['status']==3)
                            <td style="color:white;"><span class="badge2 success rounded-pill text-bg-danger">Approved</span></td>
                            <td><a class="btn btn-link" title="show" href=""><i class="fas fa-eye" style="color:blue"></i></a></td>

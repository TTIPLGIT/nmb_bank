                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="task_name" name="task_name" placeholder="Enter Instruction Name" value="{{$rows[0]['task_name']}}" autocomplete="off">
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label"> Select Valuer <span style="color: red;font-size: 16px;">*</span></label>
                                        ...
                                        <div class="col-md-6 d-none valuer_name" id="firm_name">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" type="text" id="firm_name" name="valuer_name" placeholder="Select Firm Name" autocomplete="off">
                                                    ...
                                                    @foreach($firm_reject as $key=>$row)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="description" name="description" placeholder="Enter Instruction Name" value="{{$rows[0]['inst_description']}}" autocomplete="off">
                                            </div>
                                        </div>
            ...
            <div class="card-body" id="card_header">
                ...
                <div class="table-wrapper">
                    <div class="table-responsive">
                        ...
                        <div class="col-lg-12 text-center ">
                                <a class="btn btn-labeled btn-info" href="{{ url()->previous() }}" id="backBtn" title="next" style="background: red !important; border-color:red !important; color:white !important; margin-top:15px !important;">

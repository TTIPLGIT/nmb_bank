                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" type="text" id="task_name" name="task_name" value="" Readonly>{{$rows[0]['inst_description'] }}</textarea>
                                        </div>
                                    </div>
        ...
        <div class="card" style="margin-top:3%">
            <div class="card-body" id="card_header">
                        ...
                        <table class="table table-bordered" id="align">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="color:white;"><span class="badge2 success rounded-pill text-bg-danger">Received</span></td>
                ...
                <form action="{{route('stakeholder_approve')}}" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Does the report require CGV approval?<span class="error-star" style="color:red;">*</span></label>
                            <div class="gender" style="display:flex;margin-top:2%">
                                <div>
                                    <input type="radio" class="" id="Male" name="cgv" value="1"><label for="Male"> Yes</label>
                                </div>
                                <div class="no-radiobutton" style="margin-left:8%">
                                    <input type="radio" class="" id="Female" name="cgv" value="2" checked><label for="Female"> No</label>
                                </div>
                    ...
                    <div class="col">
                        <div style="text-align:center">
                            ...
                            <a type="btn" id="reject" onclick="reject(<?php echo $data['valuer_id'] ?> )" class="btn btn-danger">Reject</a>
                    ...
                    @endif
                    @elseif($data['status'] == 5 && $data['type']==2)
                    @if($role_id == 32)
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Does the report require CGV approval?<span class="error-star" style="color:red;">*</span></label>
                    ...
                    @else
                    <input type="radio" class="d-none" id="Female" name="cgv" value="2" checked><label for="Female"></label>
                    @endif
                ...
                @if($data['cgv_approval'] == 0 && $data['stakeholder_comment'] == null||$data['cgv_approval']==2 && $data['stakeholder_comment'] == null)
                ...
                <input type="hidden" name="valuer_id" value="{{$data['valuer_id']}}">
                @if($data['status'] == 3)
                @php $stakeholder_comment=explode("'",$instruction[0]['stakeholder_comment'] ); $valuer_comment=explode("'",$instruction[0]['valuer_comment'] ); $registar_comment=explode("'",$instruction[0]['registar_comment'] );@endphp

                <div class="col-md-12 form-group">
                    <div id="" style="margin: 20px;">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="form-label" for="textAreaExample">Feedback</h3>
                            </div>
                            <div class="card-body">
                                <div class="row d-flex align-items-center">
                                    <span><b>Stakeholder-</b></span>
                                ...
                                <span> {{$stakeholder_comment[1]}}</span>
                                @if($instruction[0]['valuer_comment'] != null)
                                ...
                                <span> {{$valuer_comment[1]}}</span>
                                @endif
                                @if($instruction[0]['registar_comment'] != null)
    ...
    function Getshow(id, i_id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#valuer_comments_show').text(decodedContent);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.fire("success!", "Rejected the instruction successfully!", "success"
                            ...
                            // location.replace(`/Instruction/Process`); for valuer
                            // for stake holder

                            ...
                            <li class="dropdown dropdown-list-toggle">
                                <div class="dropdown-container">
                                    <a href="#" id="eleaning_notification" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg badges">
                                        ...
                                        <span class="badge badge-light bell_notification" style="background-color:red !important;"></span>
                        ...
                        <div id="accordion" class="py-5">
                            ...
                            <div class="card border-0">
                                <div class="card-header p-0 border-0" id="heading-239">
                                    <button class="btn btn-link accordion-title border-0 collapse {{$status_class}}" style="display:flex;justify-content: space-between;align-items: center;">{{$classContent->class_name}}
                                        @if($classContent->class_status == 2)
                                        <img src="{{asset('asset/image/tickMark.png')}}" style="margin-right: 10px;" class="clss_completed {{$status_class}}" width="20px" alt="">
                                        @endif
                                    </button>
                                </div>
                                <div id="collapse-{{$classContent->class_id}}" class="collapse" aria-labelledby="heading-{{$classContent->class_id}}" data-parent="#accordion">
                            ...
                            @php $quizz_hide = $classContent->class_status == 1 ? "classhide" : ($classContent->class_status == 2 && $classContent->quiz_status == 0 ? "classshow" : ($classContent->quiz_status == 1 ? "classcompleted" : "classhide"));
                            @endphp

                            <div class="card border-0">
                                <div class="card-header p-0 border-0" id="heading-239">
                                    <button class="btn btn-link accordion-title border-0 collapse {{$quizz_hide}}" style="display:flex;justify-content:space-between;align-items: center;">{{$quizzesWithKey[$classContent->quiz_id]->quiz_name}} (Q)
                            ...
                            <div class="card border-0">
                                <div class="card-header p-0 border-0" id="heading-239">
                                    <button class="btn btn-link accordion-title border-0 collapse exam {{$status_class}}" exam-date="{{$course_certificate[0]->exam_date}}" style="display:flex;justify-content:space-between;align-items: center;" {{$userHasExamRecord ? 'disabled' : ''}}>
                                        {{$course_certificate[0]->exam_name}} (E)

                                        @if($course_certificate[0]->exam_status == 2)
                                        <img src="{{asset('asset/image/tickMark.png')}}" style="margin-right: 10px;" class="clss_completed" width="20px" alt="">
                                        @endif
                                    </button>
                                </div>
                            </div>
                            ...
                            @if(isset($course_certificate[0]->course_certificate)&&($course_certificate[0]->course_certificate == 1))
                            @php $is_display=$course_certificate[0]->status != 2 ? "certificatehide" : "certificateshow"; @endphp

                            @if(isset($course_certificate[0]->course_certificate)&& ($course_certificate[0]->get_certified == 1))
                            @php $certified="Download Certificate"; @endphp
                            @elseif(isset($course_certificate[0]->get_certified)&&($course_certificate[0]->get_certified == 0))
                            ...
                            <div class="col-md-12">
                                ...
                                <a style="display:flex;justify-content: center;align-items: center;" class="btn btn-link accordion-title col-md-12 certificatehide" href="{{$is_display=$course_certificate[0]->course_progress == 100 || $course_certificate[0]->get_certified == 3 ? route('generatePDF',$id) : 'javascript:void(0)' }}">Get Certified
                                </a>
                                @elseif($course_exam_status == 'PASS' && $course_certificate[0]->course_progress == 100 && $course_certificate[0]->get_certified == 0)
                                <a style="display:flex;justify-content: center;align-items: center;" class="btn btn-link accordion-title col-md-12  {{$is_display}} " href="{{route('generatePDF', $id)}}">{{$certified}}</a>
                                @elseif($course_exam_status == 'FAIL' && $course_certificate[0]->get_certified == 0)
                                <a style="display:flex;justify-content: center;align-items: center;" class="btn btn-link accordion-title col-md-12  certificatehide ">{{$certified}}</a>
                               

                                @elseif($course_certificate[0]->get_certified == 1)
                                <a style="display:flex;justify-content: center;align-items: center;" class="btn btn-link accordion-title col-md-12 {{$is_display}}" href="{{asset('userdocuments/certificate/'.$course_certificate[0]->user_id.'/'.$course_certificate[0]->course_id.'/certificate.pdf')}}" download id="download_certificate">Download</a>
                                @endif
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (count == 0) {
                    ...
                    var usercount = count;
                    $('.notify').append('<span class="badge badge-light bell_notification" style="background-color:red !important;">' + usercount + '</span>');
                }
            },
        });
    }

                  ...
                  <ul class="dropdown" name="notificationMenu" style="top: 80%;">
                    ...
                    <!-- <li class="notification-group">
                      <div class="notification-tab">
                        ...
                        <h4 style="font-size:15px" class="">Instruction</h4>
                        <span class="instruction"></span>
                      </div>
                     
                      <ul class="notification-list instruction_alert_list">
      ...
      success: function (data) {
        ...
        if (count2 == 0) {
          ...
          for (var count_1 = 0; count_1 < data2['General_notifications_data'].length; count_1++) {
            ...
            $('.user_alert_list').append('<li onclick="notification(' + notification_id + ')" class="notification-list-item"><p class="message">' + alert_meg + '</p></li>');
          }
        }
        ...
        if (count4 == 0) {
          $('.user_alert_list_elearning').append('<div class="fade-in-text"><p>No new notifications</p></div>');
        } else {
          $('.user_name_alertelearning').append('<span class="label  user_name_alertelearning">' + count4 + '</span>');
          for (var count_4 = 0; count_4 < data2['Elearning_notifications_data'].length; count_4++) {
            ...
            $('.user_alert_list_elearning').append('<li onclick="notification(' + notification_id + ')" class="notification-list-item"><p class="message">' + alert_meg + '</p><p>' + formatted_date + '</span></li>');
          }
        }

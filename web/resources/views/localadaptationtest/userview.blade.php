...
<div class="main-content">
    ...
    <section class="section">
        <div class="section-body mt-1">
            <div class="row">
                {{ Breadcrumbs::render('localadaptation.quiz') }}
                ...
                $id = $quizId;
                @endphp
                <form id="quizForm" class="row" action="{{ route('localadaptation.quizstore', $quizId) }}" method="post">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <h4 class="modal-body text-center text-danger p-4 mb-0">
                Are you Sure,you want to Exit Local Adaptation Test?
            </h4>
    ...
    function answerArray(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Swal.fire({
                    title: "Are you sure,you want to submit the Local Adaptation Test?",
                    icon: "warning",

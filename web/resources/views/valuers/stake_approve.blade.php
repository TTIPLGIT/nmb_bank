                                            ...
                                            <tbody>
                                                ...
                                                <tr class="trc">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{$data['ninfp']}}" download="{{$data['ninfp']}}.pdf">{{$data['ninfn']}}</a>
                                                    </td>
...
<!-- No Table -->
                                            <tr>
                                                    ...
                                                    <th style="width: 15%">Area Of Work</th>
                                            ...
                                            @foreach($rows['work_experience'] as $key=>$data)
                                                ...
                                                <th style="width: 10%">{{$loop->iteration}}</th>
                                                    <th style="width: 23%">{{$data['fde']}}</td>
                                                    <th style="width: 16%">{{$data['tde']}}</th>
                                                    <th style="width: 15%">{{$data['aow']}}</th>
                                                    <th style="width: 20%">{{$data['des']}}</th>                                  
                                                </tr>
...
@else                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 20%">Rate of Captalization</th>
                                                    <th style="width: 20%">Income Market Cost</th>
                                                    <th style="width: 20%">Agricutural Land</th>
                                            ...
                                            @foreach($rows['work_experience'] as $key=>$data)
                                                ...
                                                <th style="width: 10%">{{$loop->iteration}}</th>
                                                    <th style="width: 23%">{{$data['cpvw']}}</td>
                                                    <th style="width: 23%">{{$data['teic']}}</td>
                                                    <th style="width: 23%">{{$data['acrr']}}</td>
                                                    <th style="width: 23%">{{$data['imc']}}</td>
                                                    <th style="width: 23%">{{$data['laal']}}</td>
                                                    <th style="width: 23%">{{$data['fde']}}</td>
                                                    <th style="width: 23%">{{$data['tde']}}</td>
                                                    <th style="width: 23%">{{$data['c_name']}}</td>                                    
                                                </tr>
                                                @endforeach
                                        ...
                                        <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="trc">
                                                    ...
                                                    <th style="width: 20%">Udemy</th>
                                                    <th style="width: 20%">Land Valuer</th>
                                                    <th style="width: 30%">2019</th>
                                                    <td>
                                                        <img style="width: 26px;" src="https://fia-uganda-edrms.com/images/pdf.png">
                ...
                <div class="col-md-8">
                    <form action="{{ route('allocate_stake_holder') }}" method="POST" id="create_form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div id="previousnotes" style="margin:20px">
                                ...
                                <div class="form-group scroll_flow_class">
                                    ...
                                    <span> <a type="button" class="btn btn-success " title="Download Documents" href="{{$data['approval_doc_path']}}/{{$data['approval_doc_name']}}" download><i class="fa fa-download" style="color:white!important"></i>{{$data['approval_doc_name']}}</a>
                                        ...
                                        <input name="valuer_id" type="hidden" value="{{$data['valuer_id']}}">

                                        <input type="file" name="stake_doc" class="btn btn-success" value=" " style="border: radius 5px !important; ;">


                                        <input name="stake_status" type="hidden" value="stake">
                                        <div class="form-outline">
                                            <label class="form-label" for="textAreaExample">your Message</label>
                                            <textarea required name="message_stake" style="color:white" class="form-control" id="textAreaExample1" rows="4"></textarea>
                                ...
                                <div style="display:flex; justify-content:center; align-items:baseline; width:100%">
                                    ...
                                    <button type="submit" id="updatebutton" class="btn btn-labeled btn-info" title="next" style="background: green !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                                        <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-check"></i></i></span>submit</button>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style=" background-color: #f8fffb;">
                ...
                <div class="row" style="margin-bottom:10px">
                    <label class="col-sm-5" style="font-size: 16px !important; color:DarkSlateBlue;">Stake Holder Name<span class="error-star" style="color:red;">*</span></label>
                ...
                <div class="row" style="margin-bottom:10px">
                    <label class="col-sm-5" style="font-size: 16px !important; color:DarkSlateBlue;">Stake Holder's Mail<span class="error-star" style="color:red;">*</span></label>
                ...
                <div class="row">
                    <label class="col-sm-5" style="font-size: 16px !important; color:DarkSlateBlue;">Messgae<span class="error-star" style="color:red;">*</span></label>
                                    ...
                                    <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 20%"> Attachments</th>
                                                <th style="width: 15%"> Passed out on</th>
                                                <th style="width: 10%">View</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="trc">
                                                <td>{{$loop->iteration}}</td>
                                                <td style="word-break: break-all;">{{$data['graduation']}}</td>
                                                <td style="word-break: break-all;">{{$data['course_name']}}</td>
                                                <td style="word-break: break-all;">{{$data['college_name']}}</td>
                                                <td style="word-break: break-all;">{{$data['m_percentage']}}</td>
                                                <td>
                                                    <img style="width: 26px;" src="https://fia-uganda-edrms.com/images/pdf.png">
                                                    <a href="{{$data['cfp']}}/{{$data['cfn']}}"><span>{{substr($data['cfn'],0,10)}}</span></a>
                                                </td>
                                                <td style="word-break: break-all;">{{$data['yop']}}</td>

                                                <td style="word-break: break-all;"><a class="btn btn-primary" title="view Document" data-toggle="modal" data-target="#templates" onclick="getproposaldocument('{{$data['cfp']}}/{{$data['cfn']}}')" style="margin-inline:5px"><input type="hidden" class="cert" id="ocfn1" name="cert[0][ocfn]" value="notes-in-13-06-2022.txt"><input type="hidden" class="cert id=" ougcfp1"="" name="cert[0][ocfp]" value="/userdocuments/registration/workexp/wc/1/0"><i class="fa fa-eye" style="color:white!important"></i></a> </td>
...
<!-- yes table -->                       
                                            ...
                                            <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Rate of Captalization</th>
                                                        <th scope="col">Income Market Cost</th>
                                                        <th scope="col">Agricutural Land</th>
                                                        <th scope="col">From Date</th>
                                                        <th scope="col">To Date</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="trc">
                                                        ...
                                                        <th scope="row">{{$loop->iteration}}</th>
                                                        <th scope="row">{{$data['cpvw']}}</td>
                                                        <th scope="row">{{$data['teic']}}</td>
                                                        <th scope="row">{{$data['acrr']}}</td>
                                                        <th >{{$data['imc']}}</td>
                                                        <th >{{$data['laal']}}</td>
                                                        <th >{{$data['fde']}}</td>
                                                        <th >{{$data['tde']}}</td>
                ...
                <div class="col-md-8">
                    <form onsubmit="checkbox_validation();" action="{{route('user_certify')}}" method="POST" id="create_form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div id="previousnotes" style="margin:20px">
                                ...
                                <div class="form-group scroll_flow_class">
                                    ...
                                    @if($data['approval_doc_path'] !="")
                                    <span> <a type="button" class="btn btn-success " title="Download Documents" href="{{$data['approval_doc_path']}}/{{$data['approval_doc_name']}}" download><i class="fa fa-download" style="color:white!important"></i>{{$data['approval_doc_name']}}</a>
                                        <br><br>
                                        @endif
                                        @endforeach
                                        @foreach($rows['general'] as $key=>$data)

                                        <input name="v_user_id" type="hidden" value="{{$data['user_id']}}">
                                        <input name="valuer_id" type="hidden" value="{{$data['id']}}">
                                        @endforeach
                                </div>
                            </div>
                            <div class="mb-4">
                                <a class="btn btn-primary" href="#" title="Certificate View" data-toggle="modal" data-target="#templates" onClick="getproposaldocument('/userdocuments/registration/valuercertification.pdf')">Preview Certificate</a>
                            </div>
                            <div>
                                ...
                                <div class="issue-btn" style="display:flex; justify-content:center; align-items:baseline; width:100%">
                                    ...
                                    <button type="submit" id="updatebutton" class="btn btn-labeled btn-info" title="next" style="background: green !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                                        <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-check"></i></i></span>Issue Certificate</button>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function checkbox_validation() {
        var chk_box = document.querySelector("#_checkbox1");
        if (chk_box.checked == false) {
            event.preventDefault();
            swal("Kindly check The Declaration Part  ", "", "error");

                                            ...
                                            <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%">$rows['general'][0]['document_type'] == "nin" ? "NIN Number" : "Passport Number"</th>  
                                        ...
                                        <table class="table table-bordered" style="text-align:center;table-layout: fixed;">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width: 11%">Institute Name</th>
...
@else                                    <div class="table-responsive">
                    ...
                    @foreach($rows['general'] as $key=>$data)
                    @if($data['v_status'] =='allocated' ||$data['v_status'] =='Reviewed')
                    ...
                    <form method="POST" action="allocate_stake_holder" id="generalupdate_form" enctype="multipart/form-data">
                        ...
                        @foreach($rows['general'] as $key=>$data)
                                   ...
                                   @if($data['v_status']=='Reviewed')       
                                   <input name="stake_status" type="hidden" value="mlhud">
                                   <input id="valuer_id" name="valuer_id" type="hidden" value="{{$data['valuer_id']}}">
                        <button type="submit" class="btn btn-warning" title="Update" style="background: blue !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-up"></i></span>Send a Response</button>
                        ...
                        <a  onclick="approve();"class="btn btn-warning" title="Update" style="background: blue !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-up"></i></span>Approve </a>
                        </div>
                     </form>
                 @else  
                 <a id="payment" data-toggle="modal" data-target="#allocate" id="" class="btn btn-warning" title="Update" style="background: blue !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-up"></i></span>Bank Allocation</a>
                          
                    <div style="display :flex; justify-content:center; align-items:baseline; width:100%" class="pb-3">    
                        <a type="button" class="btn btn-labeled btn-info" href="{{ url()->previous() }}" title="next" style="background: red !important; border-color:red !important; color:white !important; margin-top:15px !important;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-left"></i></span>Back</a>
                            <a  onclick="approve();"class="btn btn-warning" title="Update" style="background: blue !important; border-color:green !important; color:white !important; margin-top:15px !important; margin-left: 15px;">
                            <span class="btn-label" style="font-size:13px !important;"><i class="fa fa-arrow-up"></i></span>Approve </a>

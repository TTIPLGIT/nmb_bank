...
<table class="table table-bordered" id="align">
    ...
    <tbody>
        ...
        <tr>
        @php $stakeholder_Name = App\Http\Controllers\BaseController::getusername($row['stakeholder_id']);@endphp
        @php $id = Crypt::encrypt($row['government_task_id']); @endphp
        ...
        @endif
        <td>
            @if($row['task_status']=="1" || $row['task_status'] == "3")

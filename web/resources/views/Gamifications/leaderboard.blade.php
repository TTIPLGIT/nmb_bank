            ...
            <div id="main-content">
                <div class="d-flex justify-content-center">
                    <div class="leaderboard-title d-flex align-items-center gap-2">
                        <img src="/images/leaderboard/leaderboard.png"
                            style="height: 30px; width: 40px; margin-right:10px " alt="Crown" />
                ...
                <div class="container dropdown-wrapper">
                    ...
                    <!-- <div class="card p-3" style="border: none;">
                        ...
                        <div class="d-flex justify-content-end align-items-center flex-wrap gap-3 mt-3">
                            ...
                            <button class="btn bg-white text-dark d-flex align-items-center"
                                style="margin-right:10px;padding:10px" data-toggle="modal" data-target="#exampleModal">
                                <i class="fa fa-filter me-2"></i>
                            </button>

                            <div class="btn-group" role="group">
                                <button class="btn bg-white text-dark filter-btn" data-filter="ALL"
                                    style="margin-right:10px" onclick="applyFilter('ALL')">ALL</button>
                                <button class="btn bg-white text-dark filter-btn" data-filter="WEEKLY"
                                    style="margin-right:10px" onclick="applyFilter('WEEKLY')">WEEKLY</button>
                                <button class="btn bg-white text-dark filter-btn" data-filter="MONTHLY"
                                    onclick="applyFilter('MONTHLY')">MONTHLY</button>
                            </div>
                ...
                <div class="row d-flex justify-content-center   ">
                    ...
                    <div id="filterMessageAlert"
                        class="alert alert-success alert-dismissible fade show mx-auto position-relative" role="alert"
                            ...
                            <div class="col-md-3 userscard text-center float-start"
                                ...
                                <div class="mt-3 fw-bold">
                                    🎉 Congratulations <span
                                        class="text-success">{{ $rows['rows']['currentUserRank']['name'] }}</span><br>
                                    You are ranked <span
                                        class="text-success">#{{ $rows['rows']['currentUserRank']['rank'] }}</span>
                                    with

                                    @if($rows['rows']['metric_type'] === 'hours')
                                    <span class="text-danger">{{ $rows['rows']['currentUserRank']['total_hours'] }}
                                        hrs</span>
                                    @else
                    ...
                    <div class="podium d-flex justify-content-center">
                        ...
                        <div id="second-place" class="podium-card second position-relative text-center"
                            data-toggle="modal" data-target="#profile_details" style="cursor: pointer;"
                        ...
                        <div id="first-place" class="podium-card first position-relative text-center"
                            data-toggle="modal" data-target="#profile_details" style="cursor: pointer;"
                            data-id="{{ $user['id'] ?? 'N/A' }}" data-name="{{ $user['name'] ?? 'N/A' }}"
                            data-points="{{ $user['total_points'] ?? 0 }}" data-hours="{{ $user['total_hours'] ?? 0 }}"
                            data-userid="{{ $user['id'] ?? '' }}" data-level_name="{{ $user['level_name'] ?? 'N/A' }}"
                        ...
                        <div id="third-place" class="podium-card third position-relative text-center"
                            data-toggle="modal" data-target="#profile_details" style="cursor: pointer;"
                            data-id="{{ $user['id'] ?? 'N/A' }}" data-name="{{ $user['name'] ?? 'N/A' }}"
                            data-points="{{ $user['total_points'] ?? 0 }}" data-hours="{{ $user['total_hours'] ?? 0 }}"
                            data-userid="{{ $user['id'] ?? '' }}" data-level_name="{{ $user['level_name'] ?? 'N/A' }}"
                ...
                <div class="leaderboard-scroll {{ count($remainingUsers) > 3 ? 'scroll-enabled' : '' }}">
                    <table class="leaderboard-table">
                        <tbody id="rankTableBody">
                            ...
                            <tr class="leaderboard-row" data-toggle="modal" data-target="#profile_details"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content border-0 p-4">
            <div class="card-body position-relative">
                ...
                <!-- Close Button -->
                <button type="button"
                    style="color: red; margin-top: -130px; font-size: 24px; padding: 20px; margin-right: -30px; background: transparent; border: none; outline: none; box-shadow: none;"
                    id="filterclose" class="close" data-dismiss="modal" aria-hidden="true"
                    onfocus="this.blur();">&times;</button>
                ...
                <div class="text-center" style="margin-top:-50px;border-radius:10px; background-color: #f2f2f2;">
                    ...
                    <!-- Level Info -->
                    <div class="d-flex justify-content-center align-items-center gap-2 text-center mt-2"
                ...
                <div class=" mt-4 g-2 px-2" style="border-radius:10px; background-color: #f2f2f2;">
                    ...
                    <div class="row justify-content-center text-center align-items-center g-3 mt-2">
                        ...
                        <div class="{{ $colWidth }}">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/images/points_images.png" style="height: 100px; width: 100px;"
                                    class="me-2" />
                        ...
                        <div class="{{ $colWidth }}">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/images/levels_images.png"
                                    style="height: 100px; width: 100px;padding-top:4px;" class="me-2" />
                                <div class="text-start ps-3">
                                    <h5>Level</h5>
                    ...
                    <div class="col-12 mb-3">
                        <div class="py-2 px-3" style="border-top: 3px solid #b9b6b6ff;">
                            ...
                            <div class="w-100 text-center">
                                <div id="streak-container" class="d-inline-flex gap-3"
                    ...
                    <div class="col-12 mb-3">
                        <div class="py-2 px-3" style="border-top: 3px solid #b9b6b6ff;">
                            ...
                            <div class="w-100 text-center">
                                <div id="badge-container" class="d-inline-flex gap-3"
                                    style="max-height: 120px; overflow-x: auto;">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content  border-0 p-4">
            ...
            <div class="card-body position-relative">
                ...
                <button type="button" style="color:red;  font-size: 24px;padding:20px; " id="filterclose" class="close"
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="course_catagory" id="course_category_id"
                                        onclick="category()">
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-4 mt-4 mb-4"
                                ...
                                <button type="button" id="pointsbutton" onclick="toggleMetricType('points')"
                                    value="points"
    ...
    $(document).on('click', '.podium-card, .leaderboard-row', function() {
        ...
        if (level_icon) {
            $('#modal-level_icon').html(
                `<i class="${level_icon}" style="font-size:32px; color:orange;"></i>`);
        } else {
            $('#modal-level_icon').html(
                `<i class="fas fa-star" style="color: yellow; font-size: 14px;"></i>`);
        }

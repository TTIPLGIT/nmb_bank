...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-body mt-2">
      ...
      <a
        style="font-size: 15px; margin: 0 0 5px 15px;"
        class="btn btn-success btn-lg"
        href="{{ route('privacy.update', 'eyJpdiI6IkwzZmZnYVFsWkVQUDBhNjRpWnVaUGc9PSIsInZhbHVlIjoiSHh6alRZdXBnRllrNUlrVFIrY2dqZz09IiwibWFjIjoiNTRkOWQyYWY5OTQ5ZGFmMTAzOWM4YzE4MmQ2ZjA3ZjBiMTkyZTgyNWFhYzBmNDM5YWU5ODA4M2U0MjVlOTEyOSIsInRhZyI6IiJ9') }}">
        Create
      </a> @endif
      <div class="row">

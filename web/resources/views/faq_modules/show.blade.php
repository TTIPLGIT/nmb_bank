...
{{ Breadcrumbs::render('faq_modules.show',$rows[0]['id']) }}
    ...
    <h5 class="heading_align"  style="color:darkblue"> FAQ Module Show</h5>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
            <form class="form-horizontal" method="post" name ="uam_modules" >
                @csrf
                <div class="row">
                ...
                <div class="row text-center">
                        <div class="col-md-12">
                            <a class="btn btn-danger" href="{{ route('faq_modules.index') }}"><i class="fa fa-times" aria-hidden="true"></i> Cancel </a>&nbsp;

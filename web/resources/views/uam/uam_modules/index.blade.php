...
<div class="main-content module_space">
  ...
  <section class="section">
    ...
    <div class="section-body mt-2">
      ...
      <a type="button" style="font-size:15px;" class="btn btn-success btn-lg" href="{{ route('uam_modules.create') }}">Add Modules</a>
      @endif
      <div class="row">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <form action="{{ route('uam_modules.destroy', \Crypt::encrypt($row['module_id'])) }}" method="POST">
                            ...
                            <a class="btn btn-link" href="{{ route('uam_modules.show', \Crypt::encrypt($row['module_id'])) }}"><i class="fas fa-eye" style="color:blue"></i></a>
                            @endif



                            @if(strpos($screen_permission['permissions'], 'Edit') !== false)
                            <a class="btn btn-link"  href="{{ route('uam_modules.edit', \Crypt::encrypt($row['module_id'])) }}" ><i class="fas fa-pencil-alt" style="color:darkblue"></i></a>                    
                            @endif

                            @csrf
                            @method('DELETE')
                            @if(strpos($screen_permission['permissions'], 'Delete') !== false)
                            <a class="btn btn-link" title="Delete" onclick="return confirm('Are you sure you want to delete this data ?');"><i class="far fa-trash-alt" style="color:red"></i></a>
                            @endif
                          </form>

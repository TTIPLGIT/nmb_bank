                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="custom_field_id[]" id="custom_field" multiple="multiple">
                  ...
                  <div class="para"></div>
                  <input class="form-control" type="hidden" id="parent_node_id" name="parent_node_id" placeholder="Enter Password" value="">

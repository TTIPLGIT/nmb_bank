  ...
  <section class="section">
    ...
    <div class="section-body mt-2">
      ...
      <div class="d-flex flex-row justify-content-between user_space">
        <a type="button" style="font-size:15px;" class="btn btn-success btn-lg user_create customesize mb-2" href="{{ route('user.create') }}">Create</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a class="btn btn-link" href="{{ route('user.edit_permission', \Crypt::encrypt($row['id'])) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Permission"><i class="fa fa-lock" aria-hidden="true"></i><span></span></a>
                          @endif

                          @if(strpos($screen_permission['permissions'], 'Edit') !== false)
                          <a class="btn btn-link" href="{{ route('user.edit', \Crypt::encrypt($row['id'])) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i><span></span></a>
                          ...
                          <a class="btn btn-link" href="{{ route('user.show', \Crypt::encrypt($row['id'])) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Show"><i class="fa fa-eye" aria-hidden="true"></i><span></span></a>
                          @endif
                          @if(strpos($screen_permission['permissions'], 'Edit') !== false)
                          <input type="hidden" name="delete_id" id="<?php echo $row['id']; ?>" value="{{ route('user.delete', \Crypt::encrypt($row['id'])) }}">
                          <a class="btn btn-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" style="cursor: pointer;" onclick="return myFunction(<?php echo $row['id']; ?>);"><i class="fa fa-trash" aria-hidden="true"></i><span></span></a>
                          @endif

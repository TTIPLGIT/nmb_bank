...
<div class="main-content">
  ...
  <section class="section">
    ...
    <div class="section-body mt-1">
      <h5 class="heading_align"  style="color:darkblue">User Show</h5>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="roles_id">
                        ...
                        <option value="{{ $row_data['role_id'] }}" {{ $row_data['role_id'] ==  $one_row[0]['id'] ? 'selected':'' }}>{{ $row_data['role_name'] }}</option>
                        @endforeach
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="designation">
                        ...
                        <option value="{{ $row_data['role_id'] }}" {{ $row_data['role_id'] ==  $one_row[0]['id'] ? 'selected':'' }}>{{ $row['designation_name'] }}</option>
                        @endforeach
                      </select>

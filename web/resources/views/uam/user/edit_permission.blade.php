                      ...
                      <div class="col-md-12">
                        <div id="treeview_container" class="hummingbird-treeview well h-scroll-large">
                          <ul id="treeview" class="hummingbird-base">
                            ...
                            <li><i class="fa fa-plus"></i> <label> <input id="node--{{$module_data_value['module_id'] }}" data-id="{{$module_data_value['module_id'] }}" module="{{$module_data_value['module_id'] }}" type="checkbox"> {{$module_data_value['module_name'] }}</label>
                              <ul>

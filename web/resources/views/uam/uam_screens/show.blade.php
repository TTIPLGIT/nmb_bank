                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="screen_name" name="screen_name"
                                                placeholder="Enter Screen Name" value="{{ $rows[0]['screen_name'] }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Screen URL <span
                                                    style="color: red;font-size: 16px;">*</span> </label>
                                            <input class="form-control" type="text" id="screen_url" name="screen_url"
                                                placeholder="Enter Screen Name" value="{{ $rows[0]['screen_url'] }}"
                                                autocomplete="off" disabled="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="display_order"
                                                ...
                                                value="{{ $rows[0]['display_order'] }}" autocomplete="off" disabled="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="control-label">Screen Permission <span
                                                style="color: red;font-size: 16px;">*</span> </label>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" id="{{ $permission }}"
                                                        name="screen_permission[]" value="{{ $permission }}"

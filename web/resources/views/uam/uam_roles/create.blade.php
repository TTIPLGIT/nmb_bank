...
<div class="main-content">
   ...
   <section class="section">
      ...
      <div class="section-body mt-1">
         <h5 class="alignment" style="color:darkblue">Role Create</h5>
         <div class="row">
            ...
            <div class="col-12">
               ...
               <div class="card">
                  <div class="card-body">
                     <form name="uam_screens_submit" id="uam_screens_submit" method="POST" action="{{ route('uam_roles.store') }}">

                        @csrf
                        <form class="form-horizontal" name="uam_roles" id="uam_roles" method="POST" onsubmit="return validateForm()" action="{{ route('uam_roles.store') }}">
                           @csrf
                           <div class="row">
                              <div class="col-md-6">
                           ...
                           <div class="row text-center">
                              <div class="col-md-12">
                                 ...
                                 <a class="btn btn-danger footer_btn_cancel" href="{{ route('uam_roles.index') }}"><i class="fa fa-times" aria-hidden="true"></i> Cancel </a>&nbsp;
                              </div>
                           </div>
                        </form>
                  </div>

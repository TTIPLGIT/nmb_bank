          ...
          <div class="card">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="role_name" name="role_name" placeholder="Enter Role Name" value="{{ $rows[0]['role_name'] }}" autocomplete="off">
                    </div>
                    @error('role_name')
            ...
            <div class="row text-center">
              <div class="col-md-12 btn_update_undo">
                ...
                <a class="btn btn-danger footer_btn_cancel" href="{{ route('uam_roles.index') }}"><i class="fa fa-times"></i> Cancel </a>&nbsp;
              </div>
            </div>
            </form>
